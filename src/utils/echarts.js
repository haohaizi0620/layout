...
function() {
    ...
    function() {
        ...
        function n(t) {
            function e(e, a) {
                if ("string" == typeof e) {
                    var s = n[e];
                    return s || (s = o(i(e, t)), n[e] = s),
                    s
                }
                e instanceof Array && (a = a ||
                function() {},
                a.apply(this, r(e, a, t)))
            }
            var n = {};
            return e
        }
    ...
    e("zrender/graphic/Gradient", ["require"],
    function(t) {
        var e = function(t) {
            this.colorStops = t || []
        };
    ...
    e("zrender/core/util", ["require", "../graphic/Gradient"],
    function(t) {
        function e(t) {
        ...
        function i(t, n, r) {
            if (t) {
                ...
                for (var o in n) if (n.hasOwnProperty(o)) {
                    var a = t[o],
                    s = n[o]; ! w(s) || !w(a) || _(s) || _(a) || S(s) || S(a) || M(s) || M(a) ? !r && o in t || (t[o] = e(n[o], !0)) : i(a, s, r)
                }
                return t
            }
        }
        ...
        function s() {
            return P || (P = B.createCanvas().getContext("2d")),
            P
        }
        function l(t, e) {
            if (t) {
    ...
    e("echarts/util/clazz", ["require", "zrender/core/util"],
    function(t) {
        function e(t, e) {
            for (var i, n = t.constructor,
            r = t[e]; (n = n.$superClass) && (i = n.prototype[e]) && i === r;);
            return i
        }
    ...
    e("echarts/model/mixin/makeStyleMapper", ["require", "zrender/core/util"],
    function(t) {
    ...
    e("echarts/model/mixin/lineStyle", ["require", "./makeStyleMapper"],
    function(t) {
    ...
    e("echarts/model/mixin/areaStyle", ["require", "./makeStyleMapper"],
    function(t) {
        return {
            getAreaStyle: t("./makeStyleMapper")([["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]])
        }
    }),
    e("zrender/core/vector", [],
    function() {
    ...
    e("zrender/core/BoundingRect", ["require", "./vector", "./matrix"],
    function(t) {
        function e(t, e, i, n) {
            this.x = t,
            this.y = e,
    ...
    e("zrender/contain/text", ["require", "../core/util", "../core/BoundingRect"],
    function(t) {
        function e(t, e) {
            var i = t + ":" + e;
            if (s[i]) return s[i];
    ...
    e("echarts/model/mixin/textStyle", ["require", "zrender/contain/text"],
    function(t) {
        function e(t, e) {
    ...
    e("echarts/model/mixin/itemStyle", ["require", "./makeStyleMapper"],
    function(t) {
        return {
            getItemStyle: t("./makeStyleMapper")([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]])
        }
    }),
    e("echarts/model/Model", ["require", "zrender/core/util", "../util/clazz", "./mixin/lineStyle", "./mixin/areaStyle", "./mixin/textStyle", "./mixin/itemStyle"],
    function(t) {
        function e(t, e, i) {
            this.parentModel = e || null,
            this.ecModel = i || null,
            this.option = t,
        ...
        e.prototype = {
            ...
            get: function(t, e) {
                ...
                n = this.parentModel,
                r = 0; r < t.length && (i = i && "object" == typeof i ? i[t[r]] : null, null != i); r++);
    ...
    e("echarts/util/component", ["require", "zrender/core/util", "./clazz"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("./clazz"),
        n = i.parseClassType,
            ...
            t.topologicalTravel = function(t, i, r, o) {
                ...
                if (t.length) {
                    ...
                    function(t) {
                        ...
                        p = u[d],
                        f = !!h[d];
                        f && (r.call(o, d, p.originalDeps.slice()), delete h[d]),
                        e.each(p.successor, f ? s: a)
                    }
                    e.each(h,
                    function() {
    ...
    e("echarts/util/number", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
        ...
        return n.linearMap = function(t, e, r, o) {
            ...
            var s = (t - e[0]) / a;
            return o && (s = Math.min(Math.max(s, 0), 1)),
            s * (r[1] - r[0]) + r[0]
        },
    ...
    e("echarts/util/format", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
    ...
    e("echarts/util/layout", ["require", "zrender/core/util", "zrender/core/BoundingRect", "./number", "./format"],
    function(t) {
        function e(t, e, i, n, r) {
            ...
            e.eachChild(function(l, u) {
                ...
                if ("horizontal" === t) {
                    ...
                    c = o + g,
                    c > n || l.newline ? (o = 0, c = g, a += s + i, s = 0) : s = Math.max(s, p.height)
                } else {
                    var v = p.height + (m ? -m.y + p.y: 0);
                    h = a + v,
                    h > r || l.newline ? (o += s + i, a = 0, h = v, s = 0) : s = Math.max(s, p.width)
                }
        ...
        l = {};
        return l.box = e,
        l.vbox = i.curry(e, "vertical"),
        l.hbox = i.curry(e, "horizontal"),
        ...
        l.getLayoutParams = function(t) {
            var e = {};
            return t && s(["left", "right", "top", "bottom", "width", "height"],
            function(i) {
    ...
    e("echarts/model/mixin/boxLayout", ["require"],
    function(t) {
        return {
    ...
    e("echarts/model/Component", ["require", "./Model", "zrender/core/util", "../util/component", "../util/clazz", "../util/layout", "./mixin/boxLayout"],
    function(t) {
        function e(t) {
            var e = [];
        ...
        l = i.extend({
            ...
            getDefaultOption: function() {
                if (!this.hasOwnProperty("__defaultOption")) {
                    ...
                    for (var r = {},
                    o = t.length - 1; o >= 0; o--) r = n.merge(r, t[o], !0);
                    this.__defaultOption = r
                }
                return this.__defaultOption
            }
        });
        return a.enableClassExtend(l,
        function(t, e, i, r) {
            n.extend(this, r),
            this.uid = o.getUID("componentModel"),
            this.setReadOnly(["type", "id", "uid", "name", "mainType", "subType", "dependentModels", "componentIndex"])
        }),
        a.enableClassManagement(l, {
            registerWhenExtend: !0
        }),
        o.enableSubTypeDefaulter(l),
        o.enableTopologicalTravel(l, e),
    ...
    e("echarts/model/Global", ["require", "zrender/core/util", "./Model", "./Component", "./globalDefault"],
    function(t) {
        function e(t, e) {
        ...
        function r(t, e) {
            ...
            function(e, n) {
                ...
                o = t.length; o > r; r++) if (t[r].id === e.id) return void(i[n] = t.splice(r, 1)[0])
            }),
            p(e,
            function(e, n) {
                if (y(e) && e.name && !u(e)) for (var r = 0,
                o = t.length; o > r; r++) if (t[r].name === e.name) return void(i[n] = t.splice(r, 1)[0])
            }),
            p(e,
            function(e, n) {
                i[n] || !t[n] || u(e) || (i[n] = t[n])
        ...
        function o(t, e, i) {
            ...
            n(function(t, e, i, n) {
                t.name = i ? i.name: null != e.name ? e.name: o + "-",
                l[t.name] = 0
            }),
            n(function(t, e, i, n) {
                var r = t.name;
        ...
        function l(t, e) {
            return e.hasOwnProperty("subType") ? f(t,
            function(t) {
        ...
        b = d.extend({
            ...
            resetOption: function(t) {
                ...
                if (!t || "recreate" === t) {
                    var r = n.mountOption();
                    this.option && "recreate" !== t ? (this.restoreData(), this.mergeOption(r)) : i.call(this, r),
                    e = !0
                }
            ...
            mergeOption: function(t) {
                function e(e, n) {
                    var r = t[e];
                    r ? a.call(this, e, r, n) : i.call(this, e),
                    "series" === e && (this._seriesIndices = s(u.series))
                }
                function i(t) {
                    p(u[t],
                    function(t) {
            ...
            isSeriesFiltered: function(t) {
                return c(this),
                h.indexOf(this._seriesIndices, t.componentIndex) < 0
            },
    ...
    e("echarts/ExtensionAPI", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            i.each(n,
            function(e) {
    ...
    e("echarts/CoordinateSystem", ["require"],
    function(t) {
        function e() {
    ...
    e("echarts/model/OptionManager", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            this._api = t,
        ...
        function i(t, e) {
            ...
            return n || (n = t),
            n.timeline || (n.timeline = l),
            s([n].concat(r).concat(a.map(o,
            function(t) {
                return t.option
            })),
            function(t) {
        ...
        return e.prototype = {
            ...
            mountOption: function() {
                ...
                return this._timelineOptions = u(t.timelineOptions, l),
                this._mediaList = u(t.mediaList, l),
            ...
            getMediaOption: function(t) {
                ...
                for (var h = 0,
                d = r.length; d > h; h++) n(r[h].query, e, i) && s.push(h);
                return ! s.length && a && (s = [ - 1]),
                s.length && !o(s, this._currentMediaIndices) && (c = u(s,
                function(t) {
    ...
    e("echarts/util/model", ["require", "./format", "./number", "zrender/core/util", "../model/Model"],
    function(t) {
        var e = t("./format"),
        i = t("./number"),
        n = t("zrender/core/util"),
        ...
        a.eachAxisDim = a.createNameEach(o, ["axisIndex", "axis", "index"]),
        a.normalizeToArray = function(t) {
        ...
        a.createLinkedNodesFinder = function(t, e, i) {
            ...
            return function(i) {
                function n(t) { ! r(t, s) && o(t, s) && (a(t, s), l = !0)
                }
                var s = {
                    nodes: [],
                    records: {}
        ...
        a.createDataFormatModel = function(t, e, i) {
            var o = new r;
            return n.mixin(o, a.dataFormatMixin),
        ...
        a.dataFormatMixin = {
            ...
            getFormattedLabel: function(t, i, n) {
                ...
                return n || (n = o.get(["label", i, "formatter"])),
                "function" == typeof n ? (a.status = i, n(a)) : "string" == typeof n ? e.formatTpl(n, a) : void 0
            },
    ...
    e("echarts/model/Series", ["require", "zrender/core/util", "../util/format", "../util/model", "./Component"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../util/format"),
        n = t("../util/model"),
        ...
        s = r.extend({
            ...
            mergeDefaultAndTheme: function(t, i) {
                ...
                n.defaultEmphasis(t.label, ["position", "show", "textStyle", "distance", "formatter"])
            },
    ...
    e("zrender/mixin/Eventful", ["require", "../core/util"],
    function(t) {
    ...
    e("zrender/mixin/Transformable", ["require", "../core/matrix", "../core/vector"],
    function(t) {
        function e(t) {
            return t > o || -o > t
        }
        ...
        return s.decomposeTransform = function() {
            if (this.transform) {
                ...
                s[0] = r,
                s[1] = o,
                this.rotation = Math.atan2( - n[1] / o, n[0] / r)
            }
        },
        s.transformCoordToLocal = function(t, e) {
            var i = [t, e],
            r = this.invTransform;
            return r && n.applyTransform(i, i, r),
            i
        },
    ...
    e("zrender/animation/Clip", ["require", "./easing"],
    function(t) {
        function e(t) {
    ...
    function(t) {
        ...
        function c(t) {
            if (t) {
                ...
                i = 0;
                    ...
                    h = ((s - r) / 6 + l / 2) / l,
                    d = ((s - o) / 6 + l / 2) / l;
                    n === s ? e = d - h: r === s ? e = 1 / 3 + c - d: o === s && (e = 2 / 3 + h - c),
                    0 > e && (e += 1),
                    e > 1 && (e -= 1)
                }
                var p = [360 * e, i, u];
        ...
        function g(t, e, n, r) {
            return t = l(t),
            t ? (t = c(t), null != e && (t[0] = i(e)), null != n && (t[1] = o(n)), null != r && (t[2] = o(r)), y(u(t), "rgba")) : void 0
        }
        function v(t, e) {
            return t = l(t),
    ...
    e("zrender/animation/Animator", ["require", "./Clip", "../tool/color", "../core/util"],
    function(t) {
        function e(t, e) {
            return t[e]
        }
                ...
                if (!A) {
                    ...
                    var H = function(t, e) {
                        ...
                        if (0 !== a) if (O = (e - C[i]) / a, y) if (R = T[i], N = T[0 === i ? i: i - 1], B = T[i > _ - 2 ? _ - 1 : i + 1], V = T[i > _ - 3 ? _ - 1 : i + 2], w) l(N, R, B, V, O, O * O, O * O * O, m(t, d), L);
                            ...
                            var s;
                            if (M) s = l(N, R, B, V, O, O * O, O * O * O, G, 1),
                            s = h(G);
                            else {
                                if (S) return r(R, B, O);
    ...
    e("zrender/core/log", ["require", "../config"],
    function(t) {
        var e = t("../config");
        return function() {
    ...
    e("zrender/mixin/Animatable", ["require", "../animation/Animator", "../core/util", "../core/log"],
    function(t) {
        ...
        return s.prototype = {
            ...
            animateTo: function(t, e, i, o, a) {
                ...
                n(i) ? (a = o, o = i, i = 0) : r(o) ? (a = o, o = "linear", i = 0) : r(i) ? (a = i, i = 0) : r(e) ? (a = e, e = 500) : e || (e = 500),
                this.stopAnimation(),
                this._animateToShallow("", this, t, e, i, o, a);
            ...
            _animateToShallow: function(t, e, n, r, a) {
                ...
                return l > 0 && this.animate(t, !1).when(null == r ? 500 : r, s).delay(a || 0),
                this
            }
        },
        s
    }),
    e("zrender/Element", ["require", "./core/guid", "./mixin/Eventful", "./mixin/Transformable", "./mixin/Animatable", "./core/util"],
    function(t) {
        var e = t("./core/guid"),
        i = t("./mixin/Eventful"),
    ...
    e("zrender/container/Group", ["require", "../core/util", "../Element", "../core/BoundingRect"],
    function(t) {
        var e = t("../core/util"),
        i = t("../Element"),
        ...
        return r.prototype = {
            ...
            _doAdd: function(t) {
                ...
                i = this.__zr;
                e && e !== t.__storage && (e.addToMap(t), t instanceof r && t.addChildrenToStorage(e)),
                i && i.refresh()
            },
            remove: function(t) {
                var i = this.__zr,
            ...
            removeAll: function() {
                ...
                n && (n.delFromMap(t.id), t instanceof r && t.delChildrenFromStorage(n)),
                t.parent = null;
                return i.length = 0,
                this
            },
            ...
            getBoundingRect: function(t) {
                for (var e = null,
                i = new n(0, 0, 0, 0), r = t || this._children, o = [], a = 0; a < r.length; a++) {
                    var s = r[a];
    ...
    e("echarts/view/Component", ["require", "zrender/container/Group", "../util/component", "../util/clazz"],
    function(t) {
        ...
        var o = r.prototype;
        return o.updateView = o.updateLayout = o.updateVisual = function(t, e, i, n) {},
    ...
    e("echarts/view/Chart", ["require", "zrender/container/Group", "../util/component", "../util/clazz"],
    function(t) {
        function e() {
            this.group = new r,
        ...
        a.enableClassManagement(e, {
            registerWhenExtend: !0
        }),
        e
    }),
    e("zrender/graphic/Style", ["require"],
    function(t) {
    ...
    e("zrender/graphic/mixin/RectText", ["require", "../../contain/text", "../../core/BoundingRect"],
    function(t) {
        function e(t, e) {
        ...
        return a.prototype = {
            ...
            drawRectText: function(t, r, a) {
                ...
                if (null != l && (l += ""), l) {
                    ...
                    v = this.invTransform;
                    if (g && (o.copy(r), o.applyTransform(g), r = o, i(t, v)), h instanceof Array) u = r.x + e(h[0], r.width),
                    c = r.y + e(h[1], r.height),
                    p = p || "left",
                    m = m || "top";
                    else {
                    ...
                    for (var b = l.split("\n"), w = 0; w < b.length; w++) _ && t.fillText(b[w], u, c),
                    x && t.strokeText(b[w], u, c),
                    c += a.lineHeight;
                    g && i(t, g)
                }
            }
    ...
    e("zrender/graphic/Displayable", ["require", "../core/util", "./Style", "../Element", "./mixin/RectText"],
    function(t) {
        function e(t) {
            t = t || {},
            r.call(this, t);
    ...
    e("zrender/core/curve", ["require", "./vector"],
    function(t) {
        function e(t) {
            return t > -x && x > t
        }
        ...
        function l(t, e, i, r, o, a, s, l, u, c, h) {
            ...
            M[0] = u,
            M[1] = c;
            for (var w = 0; 1 > w; w += .05) S[0] = n(t, i, o, s, w),
            S[1] = n(e, r, a, l, w),
            m = v(M, S),
            b > m && (d = w, b = m);
            b = 1 / 0;
            for (var C = 0; 32 > C && !(x > y); C++) p = d - y,
            f = d + y,
            S[0] = n(t, i, o, s, p),
            S[1] = n(e, r, a, l, p),
            m = v(S, M),
            p >= 0 && b > m ? (d = p, b = m) : (L[0] = n(t, i, o, s, f), L[1] = n(e, r, a, l, f), g = v(L, M), 1 >= f && b > g ? (d = f, b = g) : y *= .5);
            return h && (h[0] = n(t, i, o, s, d), h[1] = n(e, r, a, l, d)),
            _(b)
        }
        function u(t, e, i, n) {
            var r = 1 - n;
        ...
        function f(t, e, i, n, r, o, a, s, l) {
            ...
            return l && (l[0] = u(t, i, r, c), l[1] = u(e, n, o, c)),
            _(d)
        }
        var m = t("./vector"),
        g = m.create,
    ...
    e("zrender/core/bbox", ["require", "./vector", "./curve"],
    function(t) {
        var e = t("./vector"),
        i = t("./curve"),
        n = {},
        ...
        n.fromArc = function(t, i, n, r, o, d, p, f, m) {
            var g = e.min,
            v = e.max;
            if (Math.abs(o - d) % h < 1e-4) return f[0] = t - n,
            f[1] = i - r,
            m[0] = t + n,
            void(m[1] = i + r);
    ...
    e("zrender/core/PathProxy", ["require", "./curve", "./vector", "./bbox", "./BoundingRect"],
    function(t) {
        var e = t("./curve"),
        i = t("./vector"),
        n = t("./bbox"),
        ...
        return g.prototype = {
            ...
            bezierCurveTo: function(t, e, i, n, r, a) {
                return this.addData(o.C, t, e, i, n, r, a),
                this._ctx && (this._needsDash() ? this._dashedBezierTo(t, e, i, n, r, a) : this._ctx.bezierCurveTo(t, e, i, n, r, a)),
                this._xi = r,
                this._yi = a,
                this
            },
            quadraticCurveTo: function(t, e, i, n) {
                return this.addData(o.Q, t, e, i, n),
            ...
            arc: function(t, e, i, n, r, a) {
                return this.addData(o.A, t, e, i, i, n, r - n, 0, a ? 0 : 1),
            ...
            _dashedLineTo: function(t, e) {
                ...
                v = u,
                y = a.length;
                for (d /= m, p /= m, 0 > o && (o = r + o), o %= r, g -= o * d, v -= o * p; d >= 0 && t >= g || 0 > d && g > t;) n = this._dashIdx,
                i = a[n],
                g += d * i,
                v += p * i,
                this._dashIdx = (n + 1) % y,
                d > 0 && l > g || 0 > d && g > l || s[n % 2 ? "moveTo": "lineTo"](d >= 0 ? c(g, t) : h(g, t), p >= 0 ? c(v, e) : h(v, e));
                d = g - t,
                p = v - e,
                this._dashOffset = -f(d * d + p * p)
            },
            _dashedBezierTo: function(t, i, n, r, o, a) {
                ...
                w = m.length,
                M = 0;
                for (0 > p && (p = d + p), p %= d, s = 0; 1 > s; s += .1) l = _(v, t, n, o, s + .1) - _(v, t, n, o, s),
                u = _(y, i, r, a, s + .1) - _(y, i, r, a, s),
                x += f(l * l + u * u);
                for (; w > b && (M += m[b], !(M > p)); b++);
                for (s = (M - p) / x; 1 >= s;) c = _(v, t, n, o, s),
                h = _(y, i, r, a, s),
            ...
            getBoundingRect: function() {
                a[0] = a[1] = l[0] = l[1] = Number.MAX_VALUE,
                ...
                m = 0; m < t.length;) {
                    ...
                    case o.A:
                        ...
                        w = t[m++] + b,
                        M = (t[m++], 1 - t[m++]);
                        1 == m && (h = d(b) * _ + v, f = p(b) * x + y),
                        n.fromArc(v, y, _, x, b, w, M, l, u),
                        e = d(w) * _ + v,
                        c = p(w) * x + y;
                        break;
                    case o.R:
                ...
                return 0 === m && (a[0] = a[1] = s[0] = s[1] = 0),
                new r(a[0], a[1], s[0] - a[0], s[1] - a[1])
            },
    ...
    e("zrender/contain/cubic", ["require", "../core/curve"],
    function(t) {
        var e = t("../core/curve");
        return {
    ...
    e("zrender/contain/quadratic", ["require", "../core/curve"],
    function(t) {
        var e = t("../core/curve");
        return {
    ...
    e("zrender/contain/util", ["require"],
    function(t) {
        var e = 2 * Math.PI;
        return {
    ...
    e("zrender/contain/arc", ["require", "./util"],
    function(t) {
    ...
    e("zrender/contain/path", ["require", "../core/PathProxy", "./line", "./cubic", "./quadratic", "./arc", "./util", "../core/curve", "./windingLine"],
    function(t) {
        function e(t, e) {
        ...
        function r(t, e, i, n, r, o, a, s) {
            ...
            if (u >= 0 && 1 >= u) {
                for (var c = 0,
                h = p.quadraticAt(e, n, o, u), d = 0; l > d; d++) {
        ...
        function o(t, e, i, n, r, o, a, s) {
            ...
            h = 0; 2 > h; h++) {
                ...
                if (p + t > a) {
                    ...
                    u = o ? 1 : -1;
                    0 > f && (f = g + f),
                    (f >= n && r >= f || f + g >= n && r >= f + g) && (f > Math.PI / 2 && f < 1.5 * Math.PI && (u = -u), c += u)
                }
            }
            return c
        }
        function a(t, i, a, l, d) {
            ...
            return a || e(v, _) || (p += f(g, v, y, _, l, d) || 0),
            0 !== p
        }
    ...
    e("zrender/graphic/Path", ["require", "./Displayable", "../core/util", "../core/PathProxy", "../contain/path", "./Gradient"],
    function(t) {
        function e(t) {
            var e = t.fill;
        ...
        return n.prototype = {
            ...
            brush: function(t) {
                ...
                o = i(n),
                a = e(n);
                this.__dirtyPath && (a && n.fill instanceof l && n.fill.updateCanvasGradient(this, t), o && n.stroke instanceof l && n.stroke.updateCanvasGradient(this, t)),
                n.bind(t, this),
                this.setTransform(t);
                var s = n.lineDash,
                u = n.lineDashOffset,
                c = !!t.setLineDash;
                this.__dirtyPath || s && !c && o ? (r = this.path.beginPath(t), s && !c && (r.setLineDash(s), r.setLineDashOffset(u)), this.buildPath(r, this.shape), this.__dirtyPath = !1) : (t.beginPath(), this.path.rebuildPath(t)),
                a && r.fill(t),
                s && c && (t.setLineDash(s), t.lineDashOffset = u),
                o && r.stroke(t),
            ...
            getBoundingRect: function() {
                ...
                if (!t) {
                    var n = this.path;
                    this.__dirtyPath && (n.beginPath(), this.buildPath(n, this.shape)),
                    t = n.getBoundingRect()
                }
                if (i(e) && (this.__dirty || !this._rect)) {
                    ...
                    return o = Math.max(o, this.strokeContainThreshold),
    ...
    e("zrender/tool/transformPath", ["require", "../core/PathProxy", "../core/vector"],
    function(t) {
        function e(t, e) {
    ...
    e("zrender/tool/path", ["require", "../graphic/Path", "../core/PathProxy", "./transformPath", "../core/matrix"],
    function(t) {
        ...
        function i(t) {
            ...
            for (i = 1; i < a.length; i++) {
                ...
                for (; m < g.length && !isNaN(g[m]) && !isNaN(g[0]);) {
                    ...
                    case "C":
                        d = h.C,
                        c.addData(d, g[m++], g[m++], g[m++], g[m++], g[m++], g[m++]),
                        s = g[m - 2],
                        u = g[m - 1];
                        break;
                    case "c":
                        d = h.C,
                        c.addData(d, g[m++] + s, g[m++] + u, g[m++] + s, g[m++] + u, g[m++] + s, g[m++] + u),
                        s += g[m - 2],
                        u += g[m - 1];
                        break;
                    case "S":
                        ...
                        var T = c.len(),
                        P = c.data;
                        r === h.C && (y += s - P[T - 4], _ += u - P[T - 3]),
                        d = h.C,
                        L = g[m++],
                        C = g[m++],
                        s = g[m++],
                        u = g[m++],
                        c.addData(d, y, _, L, C, s, u);
                        break;
                    case "s":
                        y = s,
                        _ = u;
    ...
    e("zrender/graphic/helper/roundRect", ["require"],
    function(t) {
        return {
            buildPath: function(t, e) {
                var i, n, r, o, a = e.x,
                ...
                r + o > l && (h = r + o, r *= l / h, o *= l / h),
                n + r > u && (h = n + r, n *= u / h, r *= u / h),
                i + o > u && (h = i + o, i *= u / h, o *= u / h),
                t.moveTo(a + i, s),
                t.lineTo(a + l - n, s),
                0 !== n && t.quadraticCurveTo(a + l, s, a + l, s + n),
                t.lineTo(a + l, s + u - r),
                0 !== r && t.quadraticCurveTo(a + l, s + u, a + l - r, s + u),
                t.lineTo(a + o, s + u),
                0 !== o && t.quadraticCurveTo(a, s + u, a, s + u - o),
                t.lineTo(a, s + i),
                0 !== i && t.quadraticCurveTo(a, s, a + i, s)
            }
        }
    }),
    e("zrender/core/LRU", ["require"],
    function(t) {
        var e = function() {
            this.head = null,
            this.tail = null,
    ...
    e("zrender/graphic/Image", ["require", "./Displayable", "../core/BoundingRect", "../core/util", "./helper/roundRect", "../core/LRU"],
    function(t) {
        var e = t("./Displayable"),
        ...
        return s.prototype = {
            ...
            getBoundingRect: function() {
                var t = this.style;
                return this._rect || (this._rect = new i(t.x || 0, t.y || 0, t.width || 0, t.height || 0)),
                this._rect
            }
        },
        n.inherits(s, e),
    ...
    e("zrender/graphic/Text", ["require", "./Displayable", "../core/util", "../contain/text"],
    function(t) {
        var e = t("./Displayable"),
        i = t("../core/util"),
        n = t("../contain/text"),
    ...
    e("zrender/graphic/shape/Circle", ["require", "../Path"],
    function(t) {
    ...
    e("zrender/graphic/shape/Sector", ["require", "../Path"],
    function(t) {
        return t("../Path").extend({
            type: "sector",
            shape: {
    ...
    e("zrender/graphic/helper/smoothSpline", ["require", "../../core/vector"],
    function(t) {
        ...
        return function(t, n) {
            for (var r = t.length,
            o = [], a = 0, s = 1; r > s; s++) a += i.distance(t[s - 1], t[s]);
            var l = a / 2;
            l = r > l ? r: l;
            for (var s = 0; l > s; s++) {
    ...
    e("zrender/graphic/helper/smoothBezier", ["require", "../../core/vector"],
    function(t) {
        var e = t("../../core/vector"),
        i = e.min,
        n = e.max,
        ...
        return function(t, s, l, u) {
            ...
            _ = t.length; _ > y; y++) {
                ...
                var S = a([], x, g),
                L = a([], x, v);
                u && (n(S, S, d), i(S, S, p), n(L, L, d), i(L, L, p)),
                f.push(S),
                f.push(L)
            }
            return l && f.push(f.shift()),
            f
        }
    }),
    e("zrender/graphic/helper/poly", ["require", "./smoothSpline", "./smoothBezier"],
    function(t) {
            ...
            buildPath: function(t, n, r) {
                ...
                if (o && o.length >= 2) {
                    if (a && "spline" !== a) {
                        ...
                        t.moveTo(o[0][0], o[0][1]);
                        for (var u = 1,
                        p = o.length; p > u; u++) t.lineTo(o[u][0], o[u][1])
                    }
                    r && t.closePath()
                }
            }
    ...
    e("zrender/graphic/shape/Polygon", ["require", "../helper/poly", "../Path"],
    function(t) {
        var e = t("../helper/poly");
        return t("../Path").extend({
            type: "polygon",
    ...
    e("zrender/graphic/shape/Polyline", ["require", "../helper/poly", "../Path"],
    function(t) {
        var e = t("../helper/poly");
        return t("../Path").extend({
            type: "polyline",
    ...
    e("zrender/graphic/shape/Rect", ["require", "../helper/roundRect", "../Path"],
    function(t) {
        ...
        return t("../Path").extend({
            ...
            buildPath: function(t, i) {
                ...
                o = i.width,
                a = i.height;
                i.r ? e.buildPath(t, i) : t.rect(n, r, o, a),
                t.closePath()
            }
        })
    }),
    e("zrender/graphic/shape/Line", ["require", "../Path"],
    function(t) {
        return t("../Path").extend({
            type: "line",
            shape: {
    ...
    e("zrender/graphic/shape/BezierCurve", ["require", "../../core/curve", "../Path"],
    function(t) {
        var e = t("../../core/curve"),
    ...
    e("zrender/graphic/shape/Arc", ["require", "../Path"],
    function(t) {
        return t("../Path").extend({
            type: "arc",
            shape: {
    ...
    e("zrender/graphic/LinearGradient", ["require", "../core/util", "./Gradient"],
    function(t) {
        var e = t("../core/util"),
        i = t("./Gradient"),
    ...
    e("zrender/graphic/RadialGradient", ["require", "../core/util", "./Gradient"],
    function(t) {
        var e = t("../core/util"),
        i = t("./Gradient"),
        n = function(t, e, n, r) {
    ...
    function(t) {
        function e(t) {
            if (!t.__isHover) {
                if (t.__hoverStlDirty) {
                    ...
                    n.stroke = n.stroke || (e instanceof y ? e: m.lift(e, -.1));
                    var r = {};
                    for (var o in n) n.hasOwnProperty(o) && (r[o] = t.style[o]);
                    t.__normalStl = r,
                    t.__hoverStlDirty = !1
                }
                t.setStyle(t.__hoverStl),
                t.z2 += 1,
                t.__isHover = !0
            }
        }
        ...
        function a() { ! this.__isEmphasis && n(this)
        }
        ...
        _ = {};
        return _.Group = t("zrender/container/Group"),
        _.Image = t("zrender/graphic/Image"),
        _.Text = t("zrender/graphic/Text"),
        _.Circle = t("zrender/graphic/shape/Circle"),
        _.Sector = t("zrender/graphic/shape/Sector"),
        _.Polygon = t("zrender/graphic/shape/Polygon"),
        _.Polyline = t("zrender/graphic/shape/Polyline"),
        _.Rect = t("zrender/graphic/shape/Rect"),
        _.Line = t("zrender/graphic/shape/Line"),
        _.BezierCurve = t("zrender/graphic/shape/BezierCurve"),
        _.Arc = t("zrender/graphic/shape/Arc"),
        _.LinearGradient = t("zrender/graphic/LinearGradient"),
        _.RadialGradient = t("zrender/graphic/RadialGradient"),
        _.extendShape = function(t) {
            return f.extend(t)
        },
        ...
        _.mergePath = d.mergePath,
        _.resizePath = function(t, e) {
            if (t.applyTransform) {
        ...
        _.subPixelOptimizeLine = function(t) {
            ...
            i = t.shape,
            n = t.style.lineWidth;
            return p(2 * i.x1) === p(2 * i.x2) && (i.x1 = i.x2 = e(i.x1, n, !0)),
            p(2 * i.y1) === p(2 * i.y2) && (i.y1 = i.y2 = e(i.y1, n, !0)),
            t
        },
        ...
        _.setHoverStyle = function(t, e) {
            ...
            t.on("mouseover", a).on("mouseout", s),
            t.on("emphasis", l).on("normal", u)
        },
        ...
        _.updateProps = h.curry(c, !0),
        _.initProps = h.curry(c, !1),
        _.getTransform = function(t, e) {
            for (var i = g.identity([]); t && t !== e;) g.mul(i, t.getLocalTransform(), i),
            t = t.parent;
            return i
        },
        _.applyTransform = function(t, e, i) {
            return i && (e = g.invert([], e)),
            v.applyTransform([], t, e)
        },
        _.transformDirection = function(t, e, i) {
            var n = 0 === e[4] || 0 === e[5] || 0 === e[0] ? 1 : Math.abs(2 * e[4] / e[0]),
            r = 0 === e[4] || 0 === e[5] || 0 === e[2] ? 1 : Math.abs(2 * e[4] / e[2]),
            o = ["left" === t ? -n: "right" === t ? n: 0, "top" === t ? -r: "bottom" === t ? r: 0];
            return o = _.applyTransform(o, e, i),
    ...
    function() {
        function t(t) {
            ...
            g && (i.chrome = !0, i.version = g[1]),
            v && (i.firefox = !0, i.version = v[1]),
            y && (i.ie = !0, i.version = y[1]),
            _ && (t.match(/Safari/) || e.ios) && (i.safari = !0),
            x && (i.webview = !0),
            y && (i.ie = !0, i.version = y[1]),
            e.tablet = !!(o || m || r && !t.match(/Mobile/) || v && t.match(/Tablet/) || y && !t.match(/Phone/) && t.match(/Touch/)),
            e.phone = !(e.tablet || e.ipod || !(r || s || l || d || p || g && t.match(/Android/) || g && t.match(/CriOS\/([\d.]+)/) || v && t.match(/Mobile/) || y && t.match(/Touch/))),
            {
                browser: i,
                os: e,
                node: !1,
    ...
    e("zrender/core/event", ["require", "../mixin/Eventful"],
    function(t) {
        function e(t) {
        ...
        function i(t, i) {
            ...
            if (r) {
                ...
                if (o) {
                    var a = e(t);
                    i.zrX = o.clientX - a.left,
                    i.zrY = o.clientY - a.top
                }
            } else {
                var s = 0,
                l = 0;
    ...
    e("zrender/mixin/Draggable", ["require"],
    function(t) {
        function e() {
    ...
    e("zrender/core/GestureMgr", ["require"],
    function(t) {
        function e(t) {
            var e = t[1][0] - t[0][0],
            i = t[1][1] - t[0][1];
    ...
    e("zrender/Handler", ["require", "./core/env", "./core/event", "./core/util", "./mixin/Draggable", "./core/GestureMgr", "./mixin/Eventful"],
    function(t) {
        function e(t) {
            return "_" + t + "Handler"
        }
        ...
        y = {
            ...
            touchend: function(t) {
                ...
                +new Date - this._lastTouchMoment < f && this._clickHandler(t)
            }
        };
        l.each(["click", "mousedown", "mouseup", "mousewheel", "dblclick"],
        function(t) {
            y[t] = function(e) {
                e = v(this.root, e);
        ...
        var _ = function(t, i, n) {
            ...
            this._gestureMgr = new c,
            r(this),
            a.os.tablet || a.os.phone ? (l.each(p,
            function(i) {
                m(t, i, this[e(i)])
            },
            this), m(t, "mouseout", this._mouseoutHandler)) : (l.each(d,
            function(i) {
                m(t, i, this[e(i)])
            },
            this), m(t, "DOMMouseScroll", this._mousewheelHandler)),
            u.call(this)
        };
        return _.prototype = {
            constructor: _,
            ...
            dispose: function() {
                for (var t = this.root,
                i = d.concat(p), n = 0; n < i.length; n++) {
                    var r = i[n];
                    g(t, r, this[e(r)])
                }
                g(t, "DOMMouseScroll", this._mousewheelHandler),
            ...
            _dispatchProxy: function(t, e, n) {
                for (var r = "on" + e,
                o = i(e, t, n), a = t; a && (a[r] && (o.cancelBubble = a[r].call(a, o)), a.trigger(e, o), a = a.parent, !o.cancelBubble););
    ...
    e("zrender/Storage", ["require", "./core/util", "./container/Group"],
    function(t) {
        function e(t, e) {
        ...
        return r.prototype = {
            ...
            updateDisplayList: function() {
                ...
                for (var n = 0,
                r = i.length; r > n; n++) i[n].__renderidx = n;
                i.sort(e)
            },
                ...
                if (!t.ignore) {
                    ...
                    if (i && (i.parent = t, i.updateTransform(), e ? (e = e.slice(), e.push(i)) : e = [i]), "group" == t.type) {
                        ...
                        r = 0; r < n.length; r++) {
                            ...
                            this._updateAndAddDisplayable(o, e)
                        }
                        t.__dirty = !1
    ...
    e("zrender/animation/Animation", ["require", "../core/util", "../core/event", "./Animator"],
    function(t) {
        var e = t("../core/util"),
    ...
    e("zrender/Layer", ["require", "./core/util", "./config"],
    function(t) {
        function e() {
            return ! 1
        }
        ...
        o = function(t, o, a) {
            var s;
            a = a || r.devicePixelRatio,
            "string" == typeof t ? s = i(t, "canvas", o, a) : n.isObject(t) && (s = t, t = s.id),
            this.id = t,
            this.dom = s;
            var l = s.style;
        ...
        return o.prototype = {
            ...
            createBackBuffer: function() {
                var t = this.dpr;
                this.domBack = i("back-" + this.id, "canvas", this.painter, t),
    ...
    e("zrender/Painter", ["require", "./config", "./core/util", "./core/log", "./core/BoundingRect", "./Layer", "./graphic/Image"],
    function(t) {
        function e(t) {
        ...
        function o(t, e, i) {
            return p.copy(t.getBoundingRect()),
            t.transform && p.applyTransform(t.transform),
            f.width = e,
            f.height = i,
            !p.intersect(f)
        }
        ...
        return m.prototype = {
            ...
            _paintList: function(t, e) {
                ...
                m = t.length; m > f; f++) {
                    ...
                    if (l !== v && (l = v, i = this.getLayer(l), i.isBuildin || c("ZLevel " + l + " has been used by unkown layer " + i.id), u = i.ctx, i.__unusedCount = 0, (i.__dirty || e) && i.clear()), (i.__dirty || e) && !g.invisible && 0 !== g.style.opacity && g.scale[0] && g.scale[1] && (!g.culling || !o(g, h, d))) {
                        var y = g.__clipPaths;
                        a(y, p) && (p && u.restore(), y && (u.save(), s(y, u)), p = y),
                        g.beforeBrush && g.beforeBrush(u),
                        g.brush(u, !1),
                        g.afterBrush && g.afterBrush(u)
                    }
                    g.__dirty = !1
                }
                p && u.restore(),
            ...
            getLayer: function(t) {
                ...
                return e || (e = new d("zr_" + t, this, this.dpr), e.isBuildin = !0, this._layerConfig[t] && u.merge(e, this._layerConfig[t], !0), this.insertLayer(t, e), e.initContext()),
                e
            },
    ...
    e("zrender/zrender", ["require", "./core/guid", "./core/env", "./Handler", "./Storage", "./animation/Animation", "./Painter"],
    function(t) {
        function e(t) {
            delete u[t]
        }
    ...
    e("echarts/loading/default", ["require", "../util/graphic", "zrender/core/util"],
    function(t) {
    ...
    e("echarts/visual/seriesColor", ["require", "zrender/graphic/Gradient"],
    function(t) {
        ...
        return function(t, i, n) {
            function r(t) {
                ...
                a.setVisual("color", s),
                n.isSeriesFiltered(t) || ("function" != typeof s || s instanceof e || a.each(function(e) {
    ...
    e("echarts/preprocessor/helper/compatStyle", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            var e = t && t.itemStyle;
            e && i.each(n,
            function(n) {
                ...
                o = e.emphasis;
                r && r[n] && (t[n] = t[n] || {},
                t[n].normal ? i.merge(t[n].normal, r[n]) : t[n].normal = r[n], r[n] = null),
                o && o[n] && (t[n] = t[n] || {},
                t[n].emphasis ? i.merge(t[n].emphasis, o[n]) : t[n].emphasis = o[n], o[n] = null)
            })
        }
        var i = t("zrender/core/util"),
        ...
        return function(t) {
            ...
            if (n) {
                ...
                r = 0; r < l.length; r++) i.isArray(l[r]) ? (e(l[r][0]), e(l[r][1])) : e(l[r])
            }
        }
    }),
    e("echarts/preprocessor/backwardCompat", ["require", "zrender/core/util", "./helper/compatStyle"],
    function(t) {
        function e(t, e) {
            e = e.split(",");
            for (var i = t,
        ...
        a = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
    ...
    e("echarts/echarts", ["require", "./model/Global", "./ExtensionAPI", "./CoordinateSystem", "./model/OptionManager", "./model/Component", "./model/Series", "./view/Component", "./view/Chart", "./util/graphic", "zrender", "zrender/core/util", "zrender/tool/color", "zrender/core/env", "zrender/mixin/Eventful", "./loading/default", "./visual/seriesColor", "./preprocessor/backwardCompat", "echarts/util/graphic", "echarts/util/number", "echarts/util/format", "echarts/coord/geo/Geo"],
    function(t) {
        function e(t, e, i) {
            t = t && t.toLowerCase(),
            C.prototype.on.call(this, t, e, i)
        }
        function i() {
            C.call(this)
        }
        function n(t, e, n) {
            ...
            this._theme = M.clone(e),
            this.Geo = T,
            this._chartsViews = [],
            this._chartsMap = {},
            this._componentsViews = [],
            this._componentsMap = {},
            this._api = new f(this),
            this._coordinateSystem = new m,
            C.call(this),
            this._messageCenter = new i,
            this._initEvents(),
            this.resize = M.bind(this.resize, this)
        }
        function r(t, e) {
            var i = this._model;
            i && i.eachComponent({
        ...
        function a(t, e) {
            ...
            n = i ? this._componentsViews: this._chartsViews, r = i ? this._componentsMap: this._chartsMap, o = this._zr, a = 0; a < n.length; a++) n[a].__keepAlive = !1;
        ...
        z.setOption = function(t, e, i) { (!this._model || e) && (this._model = new p(null, null, this._theme, new g(this._api))),
            this._model.setOption(t, V),
            I.prepareAndUpdate.call(this),
        ...
        var I = {
            update: function(t) {
                ...
                if (e) {
                    ...
                    s.call(this, e),
                    l.call(this, e),
                    this._coordinateSystem.update(e, this._api),
                    u.call(this, e, t),
                    c.call(this, e, t),
                    h.call(this, e, t);
            ...
            prepareAndUpdate: function(t) {
                var e = this._model;
                a.call(this, "component", e),
                a.call(this, "chart", e),
                I.update.call(this, t)
            }
        };
        z.resize = function() {
            this._zr.resize();
            var t = this._model && this._model.resetOption("media");
            I[t ? "prepareAndUpdate": "update"].call(this),
        ...
        z.dispatchAction = function(t, e) {
            ...
            if (i) {
                ...
                o = [t],
                a = !1;
                t.batch && (a = !0, o = M.map(t.batch,
                function(e) {
                    return e = M.defaults(M.extend({},
                    e), t),
                    e.batch = null,
                    e
                }));
        ...
        j.dispose = function(t) {
            M.isDom(t) ? t = j.getInstanceByDom(t) : "string" == typeof t && (t = G[t]),
            t instanceof n && !t.isDisposed() && t.dispose()
        },
        ...
        j.registerVisualCoding("echarts", M.curry(t("./visual/seriesColor"), "", "itemStyle")),
        j.registerPreprocessor(t("./preprocessor/backwardCompat")),
        j.registerAction({
            type: "highlight",
            event: "highlight",
            update: "highlight"
        ...
        M.noop),
        j.graphic = t("echarts/util/graphic"),
        j.number = t("echarts/util/number"),
        j.format = t("echarts/util/format"),
        j.util = {},
        P(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend"],
        function(t) {
            j.util[t] = M[t]
        }),
        j
    ...
    e("echarts/data/DataDiffer", ["require"],
    function(t) {
        function e(t) {
            return t
        }
        ...
        return i.prototype = {
            ...
            execute: function() {
                ...
                for (n(e, a, r), n(i, s, o), t = 0; t < e.length; t++) {
                    ...
                    if (null != u) {
                        var c = u.length;
                        c ? (1 === c && (s[l] = null), u = u.unshift()) : s[l] = null,
                ...
                for (var l in s) if (s.hasOwnProperty(l)) {
                    ...
                    c = u.length; c > t; t++) this._add && this._add(u[t]);
    ...
    e("echarts/data/List", ["require", "../model/Model", "./DataDiffer", "zrender/core/util", "../util/model"],
    function(t) {
        function e(t) {
        ...
        m.initData = function(t, e, i) {
            ...
            for (var p = 0; p < t.length; p++) {
                ...
                var w = e[p] || ""; ! b && w && (d[w] = d[w] || 0, b = w, d[w] > 0 && (b += "__ec__" + d[w]), d[w]++),
                b && (h[p] = b)
            }
            this._nameList = e,
            this._idList = h
        ...
        m.getDataExtent = function(t, e) {
            ...
            if (i) {
                for (var a = 1 / 0,
                s = -(1 / 0), l = 0, u = this.count(); u > l; l++) r = this.get(t, l, e),
                a > r && (a = r),
                r > s && (s = r);
        ...
        m.each = function(t, i, n, r) {
            "function" == typeof t && (r = n, n = i, i = t, t = []),
        ...
        m.setItemLayout = function(t, e, i) {
            this._itemLayouts[t] = i ? u.extend(this._itemLayouts[t] || {},
            e) : e
        },
        ...
        return m.setItemGraphicEl = function(t, e) {
            ...
            e && (e.dataIndex = t, e.seriesIndex = i && i.seriesIndex, "group" === e.type && e.traverse(v, e)),
    ...
    e("echarts/data/helper/completeDimensions", ["require", "zrender/core/util"],
    function(t) {
        function e(t, e, o) {
            var a = n(e[0]),
    ...
    e("echarts/chart/helper/createListFromArray", ["require", "../../data/List", "../../data/helper/completeDimensions", "zrender/core/util", "../../util/model"],
    function(t) {
        function e(t) {
    ...
    e("echarts/chart/line/LineSeries", ["require", "../helper/createListFromArray", "../../model/Series"],
    function(t) {
    ...
    e("echarts/util/symbol", ["require", "./graphic", "zrender/core/BoundingRect"],
    function(t) {
        var e = t("./graphic"),
        ...
        o = e.extendShape({
            ...
            buildPath: function(t, e) {
                ...
                var p = .6 * a,
                f = .7 * a;
                t.bezierCurveTo(i + c - h * p, l + s + d * p, i, n - f, i, n),
                t.bezierCurveTo(i, n - f, i - c + h * p, l + s + d * p, i - c, l + s),
                t.closePath()
            }
        }),
        a = e.extendShape({
        ...
        p = {
            createSymbol: function(t, n, r, o, a, s) {
                ...
                }) : 0 === t.indexOf("path://") ? e.makePath(t.slice(7), {},
                new i(n, r, o, a)) : new h({
                    shape: {
                        symbolType: t,
                        x: n,
    ...
    e("echarts/chart/helper/Symbol", ["require", "zrender/core/util", "../../util/symbol", "../../util/graphic", "../../util/number"],
    function(t) {
        function e(t) {
        ...
        return l._updateCommon = function(t, i, n) {
            ...
            if (v) {
                var y = o.position;
                y[0] = s.parsePercent(v[0], n[0]),
                y[1] = s.parsePercent(v[1], n[1])
            }
            o.setColor(m),
            r.extend(o.style, f.getItemStyle(["color"]));
            var _ = p.getModel(h),
            x = p.getModel(d),
            b = t.dimensions[t.dimensions.length - 1],
            w = l.getFormattedLabel(i, "normal") || t.get(b, i),
            M = o.style;
            _.get("show") ? (a.setText(M, _, m), M.text = w) : M.text = "",
            x.getShallow("show") ? (a.setText(g, x, m), g.text = w) : g.text = "",
            a.setHoverStyle(o, g);
        ...
        r.inherits(i, a.Group),
        i
    }),
    e("echarts/chart/helper/SymbolDraw", ["require", "../../util/graphic", "./Symbol"],
    function(t) {
        function e(t) {
    ...
    e("zrender/core/arrayDiff", ["require"],
    function(t) {
        function e(t, e) {
            return t === e
        }
        ...
        function o(t, e, i, a, s, l, u, c, h) {
            ...
            if (m) if (g) if (1 === m) {
                ...
                var b, w = 1 / 0,
                M = 0;
                for (p = 0; g >= p; p++) b = c[p] + h[g - p],
                w > b && (w = b, M = p);
                M += s,
                f = o(t, e, i, x, s, M, u, c, h);
    ...
    e("echarts/chart/line/lineAnimationDiff", ["require", "zrender/core/arrayDiff"],
    function(t) {
        function e(t) {
            return t >= 0 ? 1 : -1
        }
        ...
        return function(t, e, r, o, a, s) {
            for (var l = e.mapArray(e.getId), u = t.mapArray(t.getId), c = [], h = [], d = [], p = [], f = [], m = [], g = [], v = n(u, l), y = s.dimensions, _ = 0; _ < v.length; _++) {
                ...
                switch (x.cmd) {
                case "=":
                    c.push(t.getItemLayout(x.idx)),
                    h.push(e.getItemLayout(x.idx1)),
                    d.push(r[x.idx]),
                    p.push(o[x.idx1]),
                ...
                case "+":
                    var w = x.idx;
                    c.push(a.dataToPoint([e.get(y[0], w, !0), e.get(y[1], w, !0)])),
                    h.push(e.getItemLayout(w).slice()),
                    d.push(i(a, e, w)),
                    p.push(o[w]),
    ...
    e("echarts/chart/line/poly", ["require", "zrender/graphic/Path", "zrender/core/vector"],
    function(t) {
        function e(t, e, i, n, f, m, g, v, y) {
            ...
            x = 0; f > x; x++) {
                ...
                if (_ === i) t[m > 0 ? "moveTo": "lineTo"](b[0], b[1]),
                c(d, b);
                else if (y > 0) {
                    var w = _ - m,
                    M = _ + m;
                    ...
                    s(p, p, v),
                    l(p, p, g),
                    t.bezierCurveTo(d[0], d[1], p[0], p[1], b[0], b[1]),
                    u(d, b, h, y / 2)
        ...
        return {
            Polyline: n.extend({
                ...
                buildPath: function(t, n) {
                    ...
                    o = 0,
                    a = r.length,
                    s = i(r); a > o;) o += e(t, r, o, a, a, 1, s.min, s.max, n.smooth) + 1
                }
            }),
            Polygon: n.extend({
                type: "ec-polygon",
                ...
                buildPath: function(t, n) {
                    ...
                    l = i(r), u = i(o); s > a;) {
                        ...
                        e(t, o, a + c - 1, s, c, -1, u.min, u.max, n.stackedOnSmooth),
                        a += c + 1,
                        t.closePath()
                    }
                }
    ...
    e("echarts/chart/line/LineView", ["require", "zrender/core/util", "../helper/SymbolDraw", "../helper/Symbol", "./lineAnimationDiff", "../../util/graphic", "./poly", "../../view/Chart"],
    function(t) {
        function e(t, e) {
        ...
        return g.extend({
            ...
            render: function(t, n, r) {
                ...
                M || g.remove(),
                v && m.type === a.type ? (x && _.setClipPath(u(a, !1, t)), M && g.updateData(l, S), l.eachItemGraphicEl(function(t) {
                    t.stopAnimation(!0)
                    ...
                    points: p,
                    stackedOnPoints: w
                }))), s.add(_)) : (M && g.updateData(l, S), v = this._newPolyline(s, p, a, x), b && (y = this._newPolygon(s, p, w, a, x)), _.setClipPath(u(a, !0, t))),
                v.setStyle(c.defaults(h.getLineStyle(), {
            ...
            remove: function(t) {
                var e = this.group;
                e.remove(this._lineGroup),
                this._symbolDraw.remove(!0)
            }
        })
    }),
    e("echarts/visual/symbol", ["require"],
    function(t) {
    ...
    e("echarts/layout/points", ["require"],
    function(t) {
    ...
    e("echarts/chart/line", ["require", "zrender/core/util", "../echarts", "./line/LineSeries", "./line/LineView", "../visual/symbol", "../layout/points"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../echarts");
        t("./line/LineSeries"),
    ...
    e("echarts/scale/Scale", ["require", "../util/clazz"],
    function(t) {
        function e() {
    ...
    e("echarts/scale/Ordinal", ["require", "zrender/core/util", "./Scale"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("./Scale"),
        n = i.prototype,
        r = i.extend({
            ...
            normalize: function(t) {
                return "string" == typeof t && (t = e.indexOf(this._data, t)),
    ...
    e("echarts/scale/Interval", ["require", "../util/number", "../util/format", "./Scale"],
    function(t) {
        var e = t("../util/number"),
        i = t("../util/format"),
        n = t("./Scale"),
        ...
        a = n.extend({
            ...
            unionExtent: function(t) {
                ...
                t[0] < e[0] && (e[0] = t[0]),
                t[1] > e[1] && (e[1] = t[1]),
                a.prototype.setExtent.call(this, e[0], e[1])
            },
            ...
            niceExtent: function(t, i, n) {
                ...
                if (a[1] === -(1 / 0) && a[0] === 1 / 0) return a[1] = 1,
                a[0] = -1,
                this._niceExtent = [ - 1, 1],
                void(this._interval = .5);
                this.niceTicks(t, i, n);
                var l = this._interval;
                i || (a[0] = e.round(r(a[0] / l) * l)),
                n || (a[1] = e.round(o(a[1] / l) * l))
            }
        });
    ...
    e("echarts/scale/Time", ["require", "zrender/core/util", "../util/number", "./Interval"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../util/number"),
        n = t("./Interval"),
        ...
        u = function(t, e) { ("week" === t || "month" === t || "quarter" === t || "half-year" === t || "year" === t) && (t = "MM-dd\nyyyy");
            var n = i.parseDate(e),
            r = n.getFullYear(),
            o = n.getMonth() + 1,
            a = n.getDate(),
    ...
    e("echarts/scale/Log", ["require", "zrender/core/util", "./Scale", "../util/number", "./Interval"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("./Scale"),
        n = t("../util/number"),
        ...
        d = i.extend({
            type: "log",
            getTicks: function() {
                return e.map(a.getTicks.call(this),
                function(t) {
            ...
            getLabel: a.getLabel,
            scale: function(t) {
                return t = o.scale.call(this, t),
                u(c, t)
            },
            setExtent: function(t, e) {
                t = h(t) / h(c),
                e = h(e) / h(c),
                a.setExtent.call(this, t, e)
            },
            getExtent: function() {
        ...
        return e.each(["contain", "normalize"],
        function(t) {
    ...
    e("echarts/coord/axisHelper", ["require", "../scale/Ordinal", "../scale/Interval", "../scale/Time", "../scale/Log", "../scale/Scale", "../util/number", "zrender/core/util", "zrender/contain/text"],
    function(t) {
        ...
        return s.niceScaleExtent = function(t, e) {
            ...
            if ("ordinal" !== i.type) {
                ...
                a = e.get("max"),
                s = e.get("boundaryGap");
                o.isArray(s) || (s = [s || 0, s || 0]),
                s[0] = r.parsePercent(s[0], 1),
                s[1] = r.parsePercent(s[1], 1);
                var l = i.getExtent(),
                u = l[1] - l[0],
                c = !0,
                h = !0;
                null == n && (n = l[0] - s[0] * u, c = !1),
                null == a && (a = l[1] + s[1] * u, h = !1),
                "dataMin" === n && (n = l[0]),
                "dataMax" === a && (a = l[1]),
                i.setExtent(n, a),
                i.niceExtent(e.get("splitNumber"), c, h);
        ...
        s.getAxisLabelInterval = function(t, e, i, n) {
            ...
            l = 0; l < t.length; l++) {
                ...
                r ? r.intersect(c) ? (s++, o = Math.max(o, s)) : (r.union(c), s = 0) : r = c.clone()
            }
            return o
        },
        s.getFormattedLabels = function(t, e) {
            ...
            } (e), o.map(n, e)) : "function" == typeof e ? o.map(r,
            function(n, r) {
    ...
    e("echarts/coord/cartesian/Cartesian", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            return this._axes[t]
        }
    ...
    e("echarts/coord/cartesian/Cartesian2D", ["require", "zrender/core/util", "./Cartesian"],
    function(t) {
        function e(t) {
            n.call(this, t),
            this.dimensions = ["x", "y"]
    ...
    e("echarts/coord/Axis", ["require", "../util/number", "zrender/core/util"],
    function(t) {
        function e(t, e) {
            var i = t[1] - t[0],
            n = e,
        ...
        return o.prototype = {
            ...
            dataToCoord: function(t, i) {
                ...
                o = this.scale;
                return this.onBand && "ordinal" === o.type && e(r, o.count()),
                n(t, [0, 1], r, i)
            },
    ...
    e("echarts/coord/cartesian/axisLabelInterval", ["require", "zrender/core/util", "../axisHelper"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../axisHelper");
        return function(t) {
    ...
    e("echarts/coord/cartesian/Axis2D", ["require", "zrender/core/util", "../Axis", "./axisLabelInterval"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../Axis"),
    ...
    e("echarts/coord/axisDefault", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util"),
        i = {
            show: !0,
    ...
    e("echarts/coord/axisModelCreator", ["require", "./axisDefault", "zrender/core/util", "../model/Component"],
    function(t) {
        var e = t("./axisDefault"),
        i = t("zrender/core/util"),
        n = t("../model/Component"),
    ...
    e("echarts/coord/axisModelCommonMixin", ["require", "zrender/core/util", "./axisHelper"],
    function(t) {
        function e(t) {
    ...
    e("echarts/coord/cartesian/AxisModel", ["require", "../../model/Component", "zrender/core/util", "../axisModelCreator", "../axisModelCommonMixin"],
    function(t) {
        function e(t, e) {
    ...
    e("echarts/coord/cartesian/GridModel", ["require", "./AxisModel", "../../model/Component"],
    function(t) {
        t("./AxisModel");
    ...
    e("echarts/coord/cartesian/Grid", ["require", "exports", "module", "../../util/layout", "../../coord/axisHelper", "zrender/core/util", "./Cartesian2D", "./Axis2D", "./GridModel", "../../CoordinateSystem"],
    function(t, e) {
        function i(t, e, i) {
        ...
        function n(t) {
            for (var e, i = t.model,
            n = i.getFormattedLabels(), r = 0; r < n.length; r++) if (!t.isLabelIgnored(r)) {
            ...
            function(t) {
                if (!t.model.get("axisLabel.inside")) {
                    ...
                    if (e) {
                        ...
                        r[i] -= e[i] + o,
                        "top" === t.position ? r.y += e.height + o: "left" === t.position && (r.x += e.width + o)
                    }
                }
            }), i())
        },
        m.getAxis = function(t, e) {
            ...
            r = 0; r < n.length; r++) if (n[r].dim === t) return n[r]
        },
        ...
        m._initCartesian = function(t, e, n) {
            ...
            function o(n) {
                return function(r, o) {
                    if (i(r, t, e)) {
                        ...
                        "x" === n ? ("top" !== u && "bottom" !== u && (u = "bottom"), a[u] && (u = "top" === u ? "bottom": "top")) : ("left" !== u && "right" !== u && (u = "left"), a[u] && (u = "left" === u ? "right": "left")),
                        a[u] = !0;
                        var h = new c(n, s.createScaleByModel(r), [0, 0], r.get("type"), u),
                        d = "category" === h.type;
                        h.onBand = d && r.get("boundaryGap"),
                        h.inverse = r.get("inverse"),
            ...
            return e.eachComponent("xAxis", o("x"), this),
        ...
        t("../../CoordinateSystem").register("grid", r),
        r
    }),
    e("echarts/chart/bar/BarSeries", ["require", "../../model/Series", "../helper/createListFromArray"],
    function(t) {
    ...
    e("echarts/chart/bar/barItemStyle", ["require", "../../model/mixin/makeStyleMapper"],
    function(t) {
        return {
            getBarItemStyle: t("../../model/mixin/makeStyleMapper")([["fill", "color"], ["stroke", "barBorderColor"], ["lineWidth", "barBorderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]])
        }
    }),
    e("echarts/chart/bar/BarView", ["require", "zrender/core/util", "../../util/graphic", "../../model/Model", "./barItemStyle", "../../echarts"],
    function(t) {
        function e(t, e) {
            var i = t.width > 0 ? 1 : -1,
            n = t.height > 0 ? 1 : -1;
        ...
        var i = t("zrender/core/util"),
        n = t("../../util/graphic");
        return i.extend(t("../../model/Model").prototype, t("./barItemStyle")),
        t("../../echarts").extendChartView({
            ...
            _updateStyle: function(t, e, r) {
                ...
                e.eachItemGraphicEl(function(a, s) {
                    ...
                    m = a.style;
                    u.get("show") ? o(m, u, c, t.getFormattedLabel(s, "normal") || t.getRawValue(s), p) : m.text = "",
                    f.get("show") ? o(d, f, c, t.getFormattedLabel(s, "emphasis") || t.getRawValue(s), p) : d.text = "",
                    n.setHoverStyle(a, d)
                })
            },
            remove: function(t, e) {
    ...
    e("echarts/layout/barGrid", ["require", "zrender/core/util", "../util/number"],
    function(t) {
        function e(t) {
        ...
        function i(t, i) {
            ...
            function(t, i) {
                ...
                u && !s[l].width && (u = Math.min(a.remainedWidth, u), s[l].width = u, a.remainedWidth -= u),
                c && (s[l].maxWidth = c),
                null != h && (a.gap = h),
            ...
            function(t, e) {
                ...
                r.each(i,
                function(t, e) {
                    var i = t.maxWidth; ! t.width && i && d > i && (i = Math.min(i, c), c -= i, t.width = i, h--)
                }),
                d = (c - l) / (h + (h - 1) * u),
                d = Math.max(d, 0);
                var p, f = 0;
            ...
            function(t) {
                ...
                function(t, e) {
                    if (!isNaN(t)) {
                        ...
                        g = f[e],
                        v = s[o][e][m];
                        h.isHorizontal() ? (n = v, r = g[1] + u, a = g[0] - v, l = c, Math.abs(a) < d && (a = (0 > a ? -1 : 1) * d), s[o][e][m] += a) : (n = g[0] + u, r = v, a = c, l = g[1] - v, Math.abs(l) < d && (l = (0 >= l ? -1 : 1) * d), s[o][e][m] += l),
                        i.setItemLayout(e, {
                            x: n,
                            y: r,
                            width: a,
    ...
    e("echarts/chart/bar", ["require", "zrender/core/util", "../coord/cartesian/Grid", "./bar/BarSeries", "./bar/BarView", "../layout/barGrid", "../echarts"],
    function(t) {
        var e = t("zrender/core/util");
    ...
    e("echarts/component/axis/AxisBuilder", ["require", "zrender/core/util", "../../util/graphic", "../../model/Model", "../../util/number"],
    function(t) {
        function e(t, e, i) {
        ...
        var h = {
            ...
            axisTick: function() {
                ...
                if (t.get("axisTick.show")) {
                    for (var e = t.axis,
                    i = t.getModel("axisTick"), n = this.opt, o = i.getModel("lineStyle"), a = i.get("length"), s = p(i, n.labelInterval), l = e.getTicksCoords(), u = [], c = 0; c < l.length; c++) if (!d(e, c, s)) {
                        var h = l[c];
            ...
            axisName: function() {
                ...
                if (null == o && (o = n.get("name")), o) {
                    ...
                    a = "middle" === s ? e(t, t.rotation, l) : i(t, s, h),
    ...
    e("echarts/component/axis/AxisView", ["require", "zrender/core/util", "../../util/graphic", "./AxisBuilder", "../../echarts"],
    function(t) {
        function e(t, e) {
            function i(t, e) {
                var i = n.getAxis(t);
            ...
            h.x.onZero = Math.max(Math.min(i("y"), h.x.bottom), h.x.top),
            h.y.onZero = Math.max(Math.min(i("x"), h.y.right), h.y.left),
            o.position = ["y" === l ? h.y[s] : c[0], "x" === l ? h.x[s] : c[3]];
            var d = {
                x: 0,
                y: 1
            };
            ...
            o.labelDirection = o.tickDirection = o.nameDirection = p[a],
            r.onZero && (o.labelOffset = h[l][a] - h[l].onZero),
            ...
            return o.labelRotation = "top" === s ? -f: f,
        ...
        u = t("../../echarts").extendComponentView({
            ...
            _splitLine: function(t, e, i) {
                ...
                for (var d = e.coordinateSystem.getRect(), p = r.isHorizontal(), f = [], m = 0, g = r.getTicksCoords(), v = [], y = [], _ = 0; _ < g.length; _++) if (!o(r, _, h)) {
                    ...
                    var b = m++%c.length;
                    f[b] = f[b] || [],
                    f[b].push(new n.Line(n.subPixelOptimizeLine({
                        shape: {
                            x1: v[0],
                            y1: v[1],
                            x2: y[0],
    ...
    e("echarts/component/axis", ["require", "../coord/cartesian/AxisModel", "./axis/AxisView"],
    function(t) {
        t("../coord/cartesian/AxisModel"),
        t("./axis/AxisView")
    }),
    e("echarts/component/grid", ["require", "../util/graphic", "zrender/core/util", "../coord/cartesian/Grid", "./axis", "../echarts"],
    function(t) {
        var e = t("../util/graphic"),
        i = t("zrender/core/util");
        t("../coord/cartesian/Grid"),
    ...
    e("echarts/chart/helper/dataSelectableMixin", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util");
        return {
            updateSelectedMap: function() {
                var t = this.option;
                this._dataOptMap = e.reduce(t.data,
                function(t, e) {
                    return t[e.name] = e,
                    t
                },
    ...
    e("echarts/chart/pie/PieSeries", ["require", "../../data/List", "zrender/core/util", "../../util/model", "../../data/helper/completeDimensions", "../helper/dataSelectableMixin", "../../echarts"],
    function(t) {
        var e = t("../../data/List"),
        i = t("zrender/core/util"),
        n = t("../../util/model"),
        ...
        a = t("../../echarts").extendSeriesModel({
            ...
            getInitialData: function(t, i) {
                ...
                o = new e(n, this);
                return o.initData(t.data),
                o
            },
            getDataParams: function(t) {
                var e = this._data,
                i = this.$superCall("getDataParams", t);
                return i.percent = +(e.get("value", t) / e.getSum("value") * 100).toFixed(2),
                i.$vars.push("percent"),
                i
            },
    ...
    e("echarts/chart/pie/PieView", ["require", "../../util/graphic", "zrender/core/util", "../../view/Chart"],
    function(t) {
        function e(t, e, n, r) {
            var o = e.getData(),
            a = this.dataIndex,
        ...
        s.updateData = function(t, e, n) {
            ...
            h);
            d.label = null,
            n ? (l.setShape(d), l.shape.endAngle = h.startAngle, o.updateProps(l, {
                shape: {
                    endAngle: h.endAngle
                }
            },
            ...
            p.getModel("normal").getItemStyle())),
            l.hoverStyle = p.getModel("emphasis").getItemStyle(),
            i(this, t.getItemLayout(e), c.get("selected"), u.get("selectedOffset"), u.get("animation")),
            l.off("mouseover").off("mouseout").off("emphasis").off("normal"),
            c.get("hoverAnimation") && l.on("mouseover", r).on("mouseout", s).on("emphasis", r).on("normal", s),
            this._updateLabel(t, e),
            o.setHoverStyle(this)
        },
        s._updateLabel = function(t, e) {
            ...
            o.updateProps(i, {
                shape: {
                    points: u.linePoints || [[u.x, u.y], [u.x, u.y], [u.x, u.y]]
                }
            },
            a),
            o.updateProps(n, {
    ...
    e("echarts/action/createDataSelectAction", ["require", "../echarts", "zrender/core/util"],
    function(t) {
        var e = t("../echarts"),
        i = t("zrender/core/util");
        return function(t, n) {
    ...
    e("echarts/visual/dataColor", ["require"],
    function(t) {
        return function(t, e) {
            e.eachSeriesByType(t,
            function(t) {
                ...
                if (!e.isSeriesFiltered(t)) {
                    ...
                    r.each(function(t) {
                        ...
                        if (!r.getItemVisual(t, "color", !0)) {
                            ...
                            n.setItemVisual(o, "color", a),
                            r.setItemVisual(t, "color", a)
                        }
                    })
                }
            })
    ...
    e("echarts/chart/pie/labelLayout", ["require", "zrender/contain/text"],
    function(t) {
        function e(t, e, i, n, r, o, a) {
            function s(e, i, n, r) {
        ...
        return function(t, e, r, o) {
            ...
            l.each(function(i) {
                ...
                b = Math.cos(x),
                w = Math.sin(x);
                if (a = p.cx, s = p.cy, "center" === g) r = p.cx,
                o = p.cy,
                d = "center";
                else {
    ...
    e("echarts/chart/pie/pieLayout", ["require", "../../util/number", "./labelLayout", "zrender/core/util"],
    function(t) {
        var e = t("../../util/number"),
        i = e.parsePercent,
        n = t("./labelLayout"),
        ...
        return function(t, s, l) {
            ...
            function(t) {
                ...
                function(t, i) {
                    var n;
                    n = "area" !== M ? 0 === x ? b: t * b: o / (v.count() || 1),
                    _ > n ? (n = _, L -= _) : C += t;
                    var r = T + P * n;
                    v.setItemLayout(i, {
                        angle: n,
                ...
                !0), o > L) if (.001 >= L) {
                    ...
                    v.each(function(t) {
                        ...
                        e.startAngle = y + P * t * A,
                        e.endAngle = y + P * (t + 1) * A
                    })
                } else b = L / C,
                T = y,
                v.each("value",
    ...
    e("echarts/chart/pie", ["require", "zrender/core/util", "../echarts", "./pie/PieSeries", "./pie/PieView", "../action/createDataSelectAction", "../visual/dataColor", "./pie/pieLayout", "../processor/dataFilter"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../echarts");
        t("./pie/PieSeries"),
        ...
        i.registerVisualCoding("chart", e.curry(t("../visual/dataColor"), "pie")),
        i.registerLayout(e.curry(t("./pie/pieLayout"), "pie")),
        i.registerProcessor("filter", e.curry(t("../processor/dataFilter"), "pie"))
    }),
    e("echarts/chart/scatter/ScatterSeries", ["require", "../helper/createListFromArray", "../../model/Series"],
    function(t) {
        var e = t("../helper/createListFromArray"),
        i = t("../../model/Series");
        return i.extend({
    ...
    e("echarts/chart/helper/LargeSymbolDraw", ["require", "../../util/graphic", "../../util/symbol", "zrender/core/util"],
    function(t) {
        function e() {
        ...
        return a.updateData = function(t) {
            ...
            e.setShape({
                ...
                sizes: t.mapArray(function(e) {
                    ...
                    return r.isArray(i) || (i = [i, i]),
                    i
                })
            }),
            e.symbolProxy = n.createSymbol(t.getVisual("symbol"), 0, 0, 0, 0),
    ...
    e("echarts/chart/scatter/ScatterView", ["require", "../helper/SymbolDraw", "../helper/LargeSymbolDraw", "../../echarts"],
    function(t) {
    ...
    e("echarts/chart/scatter", ["require", "zrender/core/util", "../echarts", "./scatter/ScatterSeries", "./scatter/ScatterView", "../visual/symbol", "../layout/points"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../echarts");
        t("./scatter/ScatterSeries"),
        t("./scatter/ScatterView"),
        i.registerVisualCoding("chart", e.curry(t("../visual/symbol"), "scatter", "circle", null)),
        i.registerLayout(e.curry(t("../layout/points"), "scatter"))
    }),
    e("echarts/component/tooltip/TooltipModel", ["require", "../../echarts"],
    function(t) {
    ...
    e("echarts/component/tooltip/TooltipContent", ["require", "zrender/core/util", "zrender/tool/color", "zrender/core/event", "../../util/format"],
    function(t) {
        function e(t) {
        ...
        function n(t) {
            ...
            l = t.get("padding");
            return r && n.push(e(r)),
            o && (n.push("background-Color:" + s.toHex(o)), n.push("filter:alpha(opacity=70)"), n.push("background-Color:" + o)),
            c(["width", "color", "radius"],
            function(e) {
                var i = "border-" + e,
                r = h(i),
                o = t.get(r);
        ...
        return r.prototype = {
            ...
            show: function(t) {
                ...
                this.el.style.cssText = p + n(t) + ";left:" + this._x + "px;top:" + this._y + "px;",
                this._show = !0
            },
            ...
            hideLater: function(t) { ! this._show || this._inContent && this.enterable || (t ? (this._hideDelay = t, this._show = !1, this._hideTimeout = setTimeout(a.bind(this.hide, this), t)) : this.hide())
            },
            isShow: function() {
                return this._show
            }
    ...
    e("echarts/component/tooltip/TooltipView", ["require", "./TooltipContent", "../../util/graphic", "zrender/core/util", "../../util/format", "../../util/number", "../../echarts"],
    function(t) {
        function e(t, e) {
            if (!t || !e) return ! 1;
            var i = p.round;
        ...
        function s(t, e, i, n, r, s, l) {
            ...
            if (s && d.applyTransform(s.transform), "function" == typeof t && (t = t([e, i], r, d)), h.isArray(t)) e = f(t[0], u),
            i = f(t[1], c);
        ...
        t("../../echarts").extendComponentView({
            ...
            render: function(t, e, i) {
                ...
                o.off("click", a),
                o.off("mousemove", a),
                o.off("mouseout", this._hide),
                "click" === t.get("triggerOn") ? o.on("click", a, this) : (o.on("mousemove", a, this), o.on("mouseout", this._hide, this))
            },
            ...
            _prepareAxisTriggerData: function(t, e) {
                ...
                return e.eachSeries(function(t) {
                    if (l(t)) {
                        ...
                        "cartesian2d" === r.type ? (e = r.getBaseAxis(), n = e.dim + e.index) : (e = r.getBaseAxis(), n = e.dim + r.name),
                        i[n] = i[n] || {
                            coordSys: [],
                            series: []
                        },
            ...
            _tryShow: function(t) {
                ...
                if (i) if (e && null != e.dataIndex) {
                    ...
                    "axis" === (l.get("tooltip.trigger") || n) ? this._showAxisTooltip(i, r, t) : (this._ticket = "", this._hideAxisPointer(), this._resetLastHover(), this._showItemTooltipContent(a, s, t)),
                    o.dispatchAction({
                        type: "showTip",
                        from: this.uid,
            ...
            _showAxisTooltip: function(t, i, n) {
                ...
                var u = !0;
                h.each(this._seriesGroupByAxis,
                function(t) {
                    var i = t.coordSys,
                    a = i[0],
                    ...
                    "cartesian2d" !== a.type || f ? "polar" !== a.type || f || this._showPolarPointer(r, a, p, s) : this._showCartesianPointer(r, a, p, s),
                    "cross" !== o && this._showSeriesTooltipContent(a, t.series, s, c, f)
                },
                this),
                u && this._hide()
            },
            _showCartesianPointer: function(t, e, r, o) {
                ...
                u = t.get("type"),
                h = "cross" !== u;
                if ("cross" === u) a("x", o, e.getAxis("y").getGlobalExtent()),
                a("y", o, e.getAxis("x").getGlobalExtent()),
                this._updateCrossText(e, o, t);
                else {
            ...
            _showPolarPointer: function(t, e, n, o) {
                ...
                d = e.getRadiusAxis(),
                p = "cross" !== u;
                if ("cross" === u) a("angle", o, d.getExtent()),
                a("radius", o, h.getExtent()),
                this._updateCrossText(e, o, t);
                else {
                    var f = e.getAxis("radius" === n ? "angle": "radius"),
                    m = f.getExtent(); ("line" === u ? a: s)(n, o, m)
                }
            },
            ...
            _showSeriesTooltipContent: function(t, e, i, n, r) {
                ...
                if (f.payloadBatch && !r && this._api.dispatchAction({
                    ...
                    if (!r) {
                        ...
                        } else m = e[0].getData().getName(_) + "<br />" + h.map(e,
                        function(t, e) {
            ...
            _showItemTooltipContent: function(t, e, i) {
                ...
                if (u.parentModel ? u.parentModel.parentModel = a: u.parentModel = this._tooltipModel, u.get("showContent")) {
                    ...
                    l.show(u),
                    l.setContent(c),
                    s(p, i.offsetX, i.offsetY, l, f, i.target, n)
                }
            },
            ...
            dispose: function(t, e) {
                ...
                i.off("mousemove", this._tryShow),
                i.off("mouseout", this._hide),
                e.off("showTip")
            }
        })
    }),
    e("echarts/component/tooltip", ["require", "./tooltip/TooltipModel", "./tooltip/TooltipView", "../echarts", "../echarts"],
    function(t) {
    ...
    e("echarts/coord/polar/RadiusAxis", ["require", "zrender/core/util", "../Axis"],
    function(t) {
        function e(t, e) {
            n.call(this, "radius", t, e),
            this.type = "category"
        }
        var i = t("zrender/core/util"),
        n = t("../Axis");
    ...
    e("echarts/coord/polar/AngleAxis", ["require", "zrender/core/util", "../Axis"],
    function(t) {
        function e(t, e) {
            e = e || [0, 360],
    ...
    e("echarts/coord/polar/Polar", ["require", "./RadiusAxis", "./AngleAxis"],
    function(t) {
        var e = t("./RadiusAxis"),
        i = t("./AngleAxis"),
        n = function(t) {
        ...
        return n.prototype = {
            ...
            dataToPoints: function(t) {
                return t.mapArray(this.dimensions,
                function(t, e) {
                    return this.dataToPoint([t, e])
                },
                this)
    ...
    e("echarts/coord/polar/AxisModel", ["require", "zrender/core/util", "../../model/Component", "../axisModelCreator", "../axisModelCommonMixin"],
    function(t) {
        function e(t, e) {
            return e.type || (e.data ? "category": "value")
        }
        ...
        r("angle", o, e, a.angle),
        r("radius", o, e, a.radius)
    }),
    e("echarts/coord/polar/PolarModel", ["require", "./AxisModel", "../../echarts"],
    function(t) {
        t("./AxisModel"),
        t("../../echarts").extendComponentModel({
            type: "polar",
    ...
    e("echarts/coord/polar/polarCreator", ["require", "./Polar", "../../util/number", "zrender/core/util", "../../coord/axisHelper", "./PolarModel", "../../CoordinateSystem"],
    function(t) {
        function e(t, e) {
            var i = t.get("center"),
            n = t.get("radius"),
        ...
        function n(t, e, i) {
            e.eachSeries(function(e) {
                if ("polar" === e.get("coordinateSystem")) {
                    ...
                    o = n.getAngleAxis(),
                    a = e.getData();
                    r.scale.unionExtent(a.getDataExtent("radius", "category" !== r.type)),
                    o.scale.unionExtent(a.getDataExtent("angle", "category" !== o.type))
                }
            }),
            a.each(t,
            function(t) {
    ...
    e("echarts/component/axis/AngleAxisView", ["require", "zrender/core/util", "../../util/graphic", "../../model/Model", "../../echarts"],
    function(t) {
        function e(t, e, i, n) {
        ...
        t("../../echarts").extendComponentView({
            ...
            _axisLabel: function(t, e, i, o) {
                for (var a = t.axis,
                s = t.get("data"), l = t.getModel("axisLabel"), u = l.getModel("textStyle"), c = t.getFormattedLabels(), h = l.get("margin"), d = a.getLabelsCoords(), p = 0; p < i.length; p++) {
                    var f = o[1],
                    ...
                    x = u;
                    s && s[p] && s[p].textStyle && (x = new r(s[p].textStyle, u)),
    ...
    e("echarts/component/angleAxis", ["require", "../coord/polar/polarCreator", "./axis/AngleAxisView"],
    function(t) {
        t("../coord/polar/polarCreator"),
        t("./axis/AngleAxisView")
    }),
    e("echarts/component/axis/RadiusAxisView", ["require", "zrender/core/util", "../../util/graphic", "./AxisBuilder", "../../echarts"],
    function(t) {
        function e(t, e, i) {
            return {
                position: [t.cx, t.cy],
    ...
    e("echarts/component/radiusAxis", ["require", "../coord/polar/polarCreator", "./axis/RadiusAxisView"],
    function(t) {
        t("../coord/polar/polarCreator"),
        t("./axis/RadiusAxisView")
    }),
    e("echarts/component/polar", ["require", "../coord/polar/polarCreator", "./angleAxis", "./radiusAxis", "../echarts"],
    function(t) {
        t("../coord/polar/polarCreator"),
        t("./angleAxis"),
        t("./radiusAxis"),
    ...
    e("echarts/chart/radar/RadarSeries", ["require", "../helper/createListFromArray", "../../model/Series", "zrender/core/util", "../../util/number", "../../component/polar"],
    function(t) {
        var e = t("../helper/createListFromArray"),
        i = t("../../model/Series"),
        n = t("zrender/core/util"),
    ...
    e("echarts/chart/radar/RadarView", ["require", "../helper/SymbolDraw", "../../util/graphic", "zrender/core/util", "../../echarts"],
    function(t) {
        var e = t("../helper/SymbolDraw"),
        i = t("../../util/graphic"),
        n = t("zrender/core/util");
        return t("../../echarts").extendChartView({
            ...
            render: function(t, e, r) {
                ...
                if (! (u.length < 1)) {
                    ...
                    d.points.length !== u.length ? (p.points = o(), d.points = o(), i.initProps(h, f, t), i.initProps(c, f, t)) : (i.updateProps(h, f, t), i.updateProps(c, f, t)),
                    this._symbolDraw.updateData(l),
                    h.setStyle(n.extend(t.getModel("lineStyle.normal").getLineStyle(), {
                        stroke: l.getVisual("color")
                    }));
                    var m = t.getModel("areaStyle.normal");
                    c.ignore = m.isEmpty(),
                    i.setHoverStyle(h, t.getModel("lineStyle.emphasis").getLineStyle()),
                    c.ignore || (c.setStyle(n.defaults(m.getAreaStyle(), {
                        fill: l.getVisual("color"),
                        opacity: .7
                    })), i.setHoverStyle(c, t.getModel("areaStyle.emphasis").getLineStyle())),
                    s.add(h),
                    s.add(c),
                    s.add(this._symbolDraw.group),
                    this._data = l
                }
            }
        })
    }),
    e("echarts/chart/radar/backwardCompat", ["require", "zrender/core/util", "../../scale/Interval"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../scale/Interval"),
        n = e.isArray,
        ...
        return function(t) {
            ...
            a && u.length && (n(a) || (a = [a]), s ? n(s) || (s = [s]) : s = t.radiusAxis = [], l ? n(l) || (l = [l]) : l = t.angleAxis = [], r(a,
            function(n, a) {
                if (n.indicator) {
                    var c = e.map(n.indicator,
                    function(t) {
                        var e = t.min,
                        i = t.max;
                    ...
                    function(t) {
                        ...
                        i = t.axisLabel;
                        return i && i.textStyle && (e.textStyle = i.textStyle),
                        e
                    }),
                    d.startAngle = n.startAngle || 90,
                    n.axisLine && (d.splitLine = n.axisLine),
                    n.axisLabel && (d.axisLabel = n.axisLabel),
                    ...
                    function(t, e) {
                        ...
                        s = t.length;
                        if (s) {
                            for (var l = 0; s > l; l++) o = Math.min(o, t[l]),
                            a = Math.max(a, t[l]);
                            r.setExtent(o, a),
                            r.niceExtent(n.splitNumber || 5);
                            var u = r.getExtent();
                            null == c[e].min && (c[e].min = u[0]),
                            null == c[e].max && (c[e].max = u[1])
                        }
                    })
                }
            }))
    ...
    e("echarts/chart/radar", ["require", "zrender/core/util", "../echarts", "./radar/RadarSeries", "./radar/RadarView", "../visual/symbol", "../layout/points", "./radar/backwardCompat"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../echarts");
        t("./radar/RadarSeries"),
        t("./radar/RadarView"),
        i.registerVisualCoding("chart", e.curry(t("../visual/symbol"), "radar", "circle", null)),
        i.registerLayout(e.curry(t("../layout/points"), "radar")),
        i.registerPreprocessor(t("./radar/backwardCompat"))
    }),
    e("echarts/component/legend/LegendModel", ["require", "zrender/core/util", "../../model/Model", "../../echarts"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../model/Model");
        return t("../../echarts").extendComponentModel({
            ...
            init: function(t, n, r) {
                ...
                this);
                this._data = o,
                this._updateAvailableNames(r);
                var a = this.option.selected;
                if (o[0] && "single" === this.get("selectedMode")) {
                    var s = !1;
                    for (var l in a) a[l] && (this.select(l), s = !0); ! s && this.select(o[0].get("name"))
                }
            },
            mergeOption: function(t) {
                this.$superCall("mergeOption", t),
    ...
    e("echarts/component/legend/legendAction", ["require", "../../echarts", "zrender/core/util"],
    function(t) {
        function e(t, e, i) {
            var r, o = {},
            a = "toggleSelected" === t;
    ...
    e("echarts/component/helper/listComponent", ["require", "../../util/layout", "../../util/format", "../../util/graphic"],
    function(t) {
        function e(t, e, n) {
        ...
        return {
            layout: function(t, n, r) {
                i.box(n.get("orient"), t, n.get("itemGap"), r.getWidth(), r.getHeight()),
                e(t, n, r)
            },
    ...
    e("echarts/component/legend/LegendView", ["require", "zrender/core/util", "../../util/symbol", "../../util/graphic", "../helper/listComponent", "../../echarts"],
    function(t) {
        function e(t, e) {
            e.dispatchAction({
            ...
            render: function(t, o, c) {
                ...
                function(r) {
                    ...
                    if (g[s] = r, y && !v[s]) {
                        ...
                        x = _.getVisual("color");
                        t.isSelected(s) || (x = u),
                        "function" == typeof x && (x = x(y.getDataParams(0)));
                        var b = _.getVisual("legendSymbol") || "roundRect",
                        w = _.getVisual("symbol"),
                        M = this._createItem(s, r, t, b, w, d, p, f, x, h);
                        M.on("click", l(e, s, c)).on("mouseover", l(i, y, "", c)).on("mouseout", l(n, y, "", c)),
                        v[s] = !0
                    }
                },
                this),
                    ...
                    if (r.legendDataProvider) {
                        ...
                        o.each(function(a) {
                            ...
                            if (g[s] && !v[s]) {
                                ...
                                _.on("click", l(e, s, c)).on("mouseover", l(i, r, s, c)).on("mouseout", l(n, r, s, c)),
                                v[s] = !0
                            }
                        },
                        !1, this)
    ...
    e("echarts/component/legend", ["require", "./legend/LegendModel", "./legend/legendAction", "./legend/LegendView", "../echarts", "./legend/legendFilter"],
    function(t) {
    ...
    e("echarts/chart/map/MapSeries", ["require", "../../data/List", "../../echarts", "../../model/Series", "zrender/core/util", "../../data/helper/completeDimensions", "../../util/format", "../helper/dataSelectableMixin"],
    function(t) {
        function e(t, e) {
            for (var i = {},
            n = e.features,
            r = 0; r < t.length; r++) i[t[r].name] = t[r];
            for (var r = 0; r < n.length; r++) {
        ...
        h = r.extend({
            ...
            mergeOption: function(t) {
                t = this._fillOption(t),
                r.prototype.mergeOption.call(this, t),
                this.updateSelectedMap()
            },
            ...
            formatTooltip: function(t) {
                ...
                i = u(this.getRawValue(t)), n = e.getName(t), r = this.seriesGroup, o = [], a = 0; a < r.length; a++) isNaN(r[a].getRawValue(t)) || o.push(l(r[a].name));
    ...
    e("echarts/component/helper/interactionMutex", ["require"],
    function(t) {
        function e(t) {
            return t[i] || (t[i] = {})
        }
    ...
    e("echarts/component/helper/RoamController", ["require", "zrender/mixin/Eventful", "zrender/core/util", "zrender/core/event", "./interactionMutex"],
    function(t) {
        function e(t) {
        ...
        function s(t, a, s) {
            ...
            this.enable = function(e) {
                this.disable(),
                null == e && (e = !0),
                e && "scale" !== e && (t.on("mousedown", h), t.on("mousemove", d), t.on("mouseup", p)),
                e && "move" !== e && (t.on("mousewheel", f), t.on("pinch", m))
            },
    ...
    e("echarts/component/helper/MapDraw", ["require", "./RoamController", "../../util/graphic", "zrender/core/util"],
    function(t) {
        function e(t, e) {
        ...
        function r(t, e) {
            var i = new a.Group;
            this._controller = new o(t.getZr(), e ? i: null, null),
            this.group = i,
            this._updateGroup = e
        }
        ...
        return r.prototype = {
            ...
            draw: function(t, r, o, l) {
                ...
                h.removeAll();
                var d = c.scale;
                h.position = c.position.slice(),
                h.scale = d.slice();
                var p, f, m, g, v, y, _ = ["itemStyle", "normal"],
                x = ["itemStyle", "emphasis"],
                b = ["label", "normal"],
                w = ["label", "emphasis"];
                u || (p = t.getModel(_), f = t.getModel(x), m = e(p, d), g = e(f, d), v = t.getModel(b), y = t.getModel(w)),
                s.each(c.regions,
                function(i) {
                    var n, r = new a.Group;
                    if (u) {
                    ...
                    u && u.setItemGraphicEl(n, r),
                    a.setHoverStyle(r, g),
                    h.add(r)
                }),
                this._updateController(t, r, o),
                u && i(t, u, h, o, l),
                u && n(t, u)
            },
            remove: function() {
    ...
    e("echarts/chart/map/MapView", ["require", "../../util/graphic", "../../component/helper/MapDraw", "../../echarts"],
    function(t) {
        var e = t("../../util/graphic"),
                    ...
                    if (!isNaN(t)) {
                        ...
                        if (n && n.point) {
                            ...
                            if (!s) {
                                ...
                                m.on("mouseover", g).on("mouseout", v).on("emphasis", g).on("normal", v),
                                v()
                            }
                            o.add(l)
                        }
    ...
    e("echarts/action/roamHelper", ["require"],
    function(t) {
        var e = {};
    ...
    e("echarts/action/geoRoam", ["require", "zrender/core/util", "./roamHelper", "../echarts"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("./roamHelper"),
        n = t("../echarts"),
    ...
    e("echarts/coord/geo/GeoModel", ["require", "../../util/model", "../../model/Component"],
    function(t) {
        var e = t("../../util/model"),
        i = t("../../model/Component");
        i.extend({
            ...
            init: function(t) {
                ...
                e.defaultEmphasis(t.label, ["position", "show", "textStyle", "distance", "formatter"])
            },
            defaultOption: {
                zlevel: 0,
                z: 0,
    ...
    e("zrender/contain/polygon", ["require", "./windingLine"],
    function(t) {
        function e(t, e) {
        ...
        function i(t, i, r) {
            ...
            for (var s = 1; s < t.length; s++) {
                var l = t[s];
                o += n(a[0], a[1], l[0], l[1], i, r),
                a = l
            }
            var u = t[0];
            return e(a[0], u[0]) && e(a[1], u[1]) || (o += n(a[0], a[1], u[0], u[1], i, r)),
            0 !== o
        }
        var n = t("./windingLine"),
        r = 1e-8;
    ...
    e("echarts/coord/geo/Region", ["require", "zrender/contain/polygon", "zrender/core/BoundingRect", "zrender/core/bbox", "zrender/core/vector"],
    function(t) {
        function e(t, e, i) {
        ...
        return e.prototype = {
            ...
            getBoundingRect: function() {
                ...
                i = [e, e], a = [ - e, -e], s = [], l = [], u = this.contours, c = 0; c < u.length; c++) r.fromPoints(u[c], s, l),
                o.min(i, i, s),
                o.max(a, a, l);
                return 0 === c && (i[0] = i[1] = a[0] = a[1] = 0),
                this._rect = new n(i[0], i[1], a[0] - i[0], a[1] - i[1])
            },
            contain: function(t) {
                var e = this.getBoundingRect(),
                n = this.contours;
                if (e.contain(t[0], t[1])) for (var r = 0,
                o = n.length; o > r; r++) if (i.contain(n[r], t[0], t[1])) return ! 0;
                return ! 1
            },
    ...
    e("echarts/coord/geo/parseGeoJson", ["require", "zrender/core/util", "./Region"],
    function(t) {
        function e(t) {
            if (!t.UTF8Encoding) return t;
            for (var e = t.features,
            n = 0; n < e.length; n++) for (var r = e[n], o = r.geometry, a = o.coordinates, s = o.encodeOffsets, l = 0; l < a.length; l++) {
                var u = a[l];
    ...
    e("echarts/coord/View", ["require", "zrender/core/vector", "zrender/core/matrix", "zrender/mixin/Transformable", "zrender/core/util", "zrender/core/BoundingRect"],
    function(t) {
        function e() {
            o.call(this)
        }
        ...
        i.prototype = {
            ...
            transformTo: function(t, e, i, n) {
                ...
                o.transform = r.calculateTransform(new s(t, e, i, n)),
                o.decomposeTransform(),
                this._updateTransform()
            },
            setPan: function(t, e) {
                this._roamTransform.position = [t, e],
                this._updateTransform()
            },
            setZoom: function(t) {
            ...
            _updateTransform: function() {
                ...
                t.updateTransform(),
                e.updateTransform(),
                e.transform && r.copy(this.transform || (this.transform = []), e.transform),
                this.decomposeTransform()
            },
    ...
    e("echarts/coord/geo/fix/nanhai", ["require", "../Region"],
    function(t) {
    ...
    e("echarts/coord/geo/fix/textCoord", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util"),
        i = {
            "南海诸岛": [32, 80],
    ...
    e("echarts/coord/geo/fix/geoCoord", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util"),
        i = {
            Russia: [100, 60],
    ...
    e("echarts/coord/geo/Geo", ["require", "./parseGeoJson", "zrender/core/util", "zrender/core/BoundingRect", "../View", "./fix/nanhai", "./fix/textCoord", "./fix/geoCoord"],
    function(t) {
        function e(t, e, i, n, r) {
            o.call(this, t),
            this.map = e,
        ...
        return e.prototype = {
            ...
            dataToPoint: function(t) {
                return "string" == typeof t && (t = this.getGeoCoord(t)),
                t ? o.prototype.dataToPoint.call(this, t) : void 0
            }
        },
        n.mixin(e, o),
        e
    }),
    e("echarts/coord/geo/geoCreator", ["require", "./GeoModel", "./Geo", "../../util/layout", "zrender/core/util", "../../echarts"],
    function(t) {
        function e(t, e) {
        ...
        l = t("../../echarts");
        l.registerMap = s.registerMap,
        l.getMap = s.getMap,
        l.loadMap = function() {},
        l.registerCoordinateSystem("geo", s)
    }),
    e("echarts/chart/map/mapSymbolLayout", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util");
        return function(t) {
            var i = {};
            ...
            function(n) {
                ...
                if (!i[r]) {
                    ...
                    function(e) {
                        ...
                        n = e.getData();
                        e.get("showLegendSymbol") && t.getComponent("legend") && n.each("value",
                        function(t, e) {
                            var r = n.getName(e),
                            a = i.getRegion(r);
                            if (a && !isNaN(t)) {
    ...
    e("echarts/chart/map/mapVisual", ["require"],
    function(t) {
        return function(t) {
            t.eachSeriesByType("map",
            function(t) {
    ...
    e("echarts/chart/map/mapDataStatistic", ["require", "zrender/core/util"],
    function(t) {
        function e(t, e) {
            for (var i = {},
            n = ["value"], r = 0; r < t.length; r++) t[r].each(n,
            function(e, n) {
                var o = t[r].getName(n);
                i[o] = i[o] || [],
                isNaN(e) || i[o].push(e)
            ...
            return t[0].map(n,
            function(n, r) {
                for (var o = t[0].getName(r), a = 0, s = 1 / 0, l = -(1 / 0), u = i[o].length, c = 0; u > c; c++) s = Math.min(s, i[o][c]),
                l = Math.max(l, i[o][c]),
                a += i[o][c];
                var h;
                return h = "min" === e ? s: "max" === e ? l: "average" === e ? a / u: a,
                0 === u ? NaN: h
            })
        }
        var i = t("zrender/core/util");
        return function(t) {
            ...
            function(t, n) {
                ...
                t[0].seriesGroup = [],
                t[0].setData(r);
                for (var o = 0; o < t.length; o++) t[o].seriesGroup = t,
                t[o].needsDrawMap = 0 === o
            })
        }
    }),
    e("echarts/chart/map/backwardCompat", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            var e = {};
            return i.each(n,
            ...
            function(n) {
                if (n.map = n.map || n.mapType, i.defaults(n, n.mapLocation), n.markPoint) {
                    ...
                    function(t) {
                        ...
                        var l = n.markPoint;
                        l.type = t.effect && t.effect.show ? "effectScatter": "scatter",
                        l.coordinateSystem = "geo",
                        l.geoIndex = i.indexOf(t.geo, s),
                        l.name = n.name,
                        t.series.splice(i.indexOf(t.series, n), 1, l)
                    }
                }
            })
        }
    }),
    e("echarts/chart/map", ["require", "../echarts", "./map/MapSeries", "./map/MapView", "../action/geoRoam", "../coord/geo/geoCreator", "./map/mapSymbolLayout", "./map/mapVisual", "./map/mapDataStatistic", "./map/backwardCompat", "../action/createDataSelectAction"],
    function(t) {
        var e = t("../echarts");
        t("./map/MapSeries"),
        t("./map/MapView"),
        ...
        e.registerLayout(t("./map/mapSymbolLayout")),
        e.registerVisualCoding("chart", t("./map/mapVisual")),
        e.registerProcessor("statistic", t("./map/mapDataStatistic")),
        e.registerPreprocessor(t("./map/backwardCompat")),
    ...
    e("echarts/data/helper/linkList", ["require", "zrender/core/util"],
    function(t) {
        function e(t, e, n) {
            return i.each(r,
            function(r, o) {
    ...
    e("echarts/data/Tree", ["require", "zrender/core/util", "../model/Model", "./List", "./helper/linkList", "./helper/completeDimensions"],
    function(t) {
        function e(t, e) {
            this.root,
            this.data,
        ...
        e.prototype = {
            ...
            update: function() {
                ...
                e = this._nodes,
                i = 0,
                n = e.length; n > i; i++) e[i].dataIndex = -1;
                for (var i = 0,
                n = t.count(); n > i; i++) e[t.getRawIndex(i)].dataIndex = i
            }
        },
    ...
    e("echarts/chart/treemap/TreemapSeries", ["require", "../../model/Series", "../../data/Tree", "zrender/core/util", "../../model/Model", "../../util/format"],
    function(t) {
        function e(t, i) {
            var n = 0;
            o.each(t.children,
            ...
            var r = t.value;
            i >= 0 && (o.isArray(r) ? r = r[0] : t.value = new Array(i)),
            (null == r || isNaN(r)) && (r = n),
            0 > r && (r = 0),
    ...
    e("echarts/chart/treemap/helper", ["require"],
    function(t) {
        var e = {
    ...
    e("echarts/chart/treemap/Breadcrumb", ["require", "../../util/graphic", "../../util/layout", "zrender/core/util"],
    function(t) {
        function e(t, e) {
            this.group = new n.Group,
            t.add(this.group),
            this._onSelect = e || o.noop
        }
        function i(t, e, i, n, r, o) {
            var a = [[r ? t: t - l, e], [t + i, e], [t + i, e + n], [r ? t: t - l, e + n]];
            return ! o && a.splice(2, 0, [t + i + l, e + n / 2]),
            !r && a.push([t, e + n / 2]),
            a
        }
        var n = t("../../util/graphic"),
        ...
        return e.prototype = {
            ...
            _renderContent: function(t, e, a, l, u) {
                for (var c = 0,
                h = a.emptyItemWidth,
                d = t.get("height"), p = r.getAvailableSize(a.pos, a.box), f = a.totalWidth, m = a.renderList, g = m.length - 1; g >= 0; g--) {
                    var v = m[g],
                    y = v.width,
                    _ = v.text;
                    f > p.width && (f -= y - h, y = h, _ = ""),
                    this.group.add(new n.Polygon({
                        shape: {
    ...
    e("echarts/util/animation", ["require", "zrender/core/util"],
    function(t) {
        function e() {
            var t, e = [],
            n = {};
    ...
    e("echarts/chart/treemap/TreemapView", ["require", "zrender/core/util", "../../util/graphic", "../../data/DataDiffer", "./helper", "./Breadcrumb", "../../component/helper/RoamController", "zrender/core/BoundingRect", "zrender/core/matrix", "../../util/animation", "../../echarts"],
    function(t) {
        function e() {
            return {
                nodeGroup: [],
        ...
        return t("../../echarts").extendChartView({
            ...
            render: function(t, e, n, r) {
                ...
                if (! (i.indexOf(a, t) < 0)) {
                    ...
                    u || s && "treemapZoomToNode" !== s ? h.renderFinally() : this._doAnimation(c, h, t),
            ...
            _giveContainerGroup: function(t) {
                ...
                return e || (e = this._containerGroup = new d, this._initEvents(e), this.group.add(e)),
                e.position = [t.x, t.y],
                e
            },
            ...
            _renderNode: function(t, e, n, r, o, a, s, l) {
                function u(i, r) {
                    var o = null != g && e[i][g],
                    a = n[i];
                    return o ? (e[i][g] = null, c(a, o, i)) : x || (o = new r, h(a, o, i)),
                    t[i][m] = o
                }
                function c(t, e, n) {
                    var r = t[m] = {};
                    r.old = "nodeGroup" === n ? e.position.slice() : i.extend({},
                    e.shape)
                }
                function h(t, e, i) {
                    if ("background" === i) e.invisible = !0,
                    e.__tmWillVisible = !0,
                    o.push(e);
                    else {
                    ...
                    if (b) {
                        ...
                        if (!M || !M.length) {
                            ...
                            if (L) {
                                ...
                                z = A.getTextRect(D),
                                I = P.get("show"); ! I || z.height > T ? D = "": z.width > C && (D = A.get("ellipsis") ? A.ellipsis(D, C) : ""),
                                L.dataIndex = a.dataIndex,
                                L.seriesIndex = this.seriesModel.seriesIndex,
                                L.culling = !0,
                                L.setShape({
                                    x: S,
                                    y: S,
            ...
            _resetController: function(t) {
                function e(t) {
                    return this._mayClick = !1,
                    t.apply(this, Array.prototype.slice.call(arguments, 1))
                }
                var i = this._controller;
                return i || (i = this._controller = new s(t.getZr()), i.enable(), i.on("pan", h(e, this, this._onPan)), i.on("zoom", h(e, this, this._onZoom))),
                i.rect = new l(0, 0, t.getWidth(), t.getHeight()),
                this.seriesModel.get("roam") ? void 0 : (i.off("pan").off("zoom"), void(this._controller = null))
            },
            _onPan: function(t, e) {
    ...
    e("echarts/chart/treemap/treemapAction", ["require", "../../echarts"],
    function(t) {
        var e = t("../../echarts"),
        i = function() {};
        e.registerAction({
    ...
    e("echarts/visual/VisualMapping", ["require", "zrender/core/util", "zrender/tool/color", "../util/number"],
    function(t) {
        function e(t) {
            var e = t.pieceList;
        ...
        function n(t) {
            return {
                applyVisual: function(e, i, n) {
                    var r = i("color"),
                    o = l.isArray(e);
                    if (e = o ? [this.mapValueToVisual(e[0]), this.mapValueToVisual(e[1])] : this.mapValueToVisual(e), l.isArray(r)) for (var a = 0,
                    s = r.length; s > a; a++) r[a].color = t(r[a].color, o ? e[a] : e);
                    else n("color", t(r, e))
                },
                mapValueToVisual: function(t) {
                    ...
                    return null == i && (i = s(this) ? a(this, n, e) : c(e, [0, 1], n, !0)),
                    i
                }
            }
        }
        ...
        f = function(t) {
            ...
            this._getSpecifiedVisual = l.bind(v[n], this, r),
            l.extend(this, m[r]),
            "piecewise" === n && e(o),
            "category" === n && i(o)
        };
        ...
        var m = f.visualHandlers = {
            color: {
                ...
                getColorMapper: function() {
                    ...
                    function(e, i) {
                        ...
                        r ? n: l.stringify(n, "rgba")
                    },
                    this)
                },
                mapValueToVisual: function(t) {
                    var e = this.option.visual;
                    if (l.isArray(t)) return t = [this._normalizeData(t[0]), this._normalizeData(t[1])],
                    u.mapIntervalToColor(t, e);
                    var i = this._normalizeData(t),
                    n = this._getSpecifiedVisual(t);
                    return null == n && (n = s(this) ? a(this, e, i) : u.mapToColor(i, e)),
                    n
                }
            },
            ...
            symbol: {
                ...
                mapValueToVisual: function(t) {
                    ...
                    i = this._getSpecifiedVisual(t),
                    n = this.option.visual;
                    return null == i && (i = s(this) ? a(this, n, e) : r(n, e) || {}),
                    i
                }
            },
            symbolSize: {
    ...
    e("echarts/chart/treemap/treemapVisual", ["require", "../../visual/VisualMapping", "zrender/tool/color", "zrender/core/util"],
    function(t) {
        ...
        return function(t, i) {
            ...
            function(t) {
                ...
                r = t.getModel(p);
                if (!n.isRemoved()) {
                    var o = h.map(i.levelModels,
                    function(t) {
                        return t ? t.get(p) : null
                    });
                    e(n, {},
                    o, r, t.getViewRoot().getAncestors(), t)
                }
            })
        }
    }),
    e("echarts/chart/treemap/treemapLayout", ["require", "zrender/core/util", "../../util/number", "../../util/layout", "zrender/core/BoundingRect", "./helper"],
    function(t) {
        function e(t, e, n) {
            var r = {
                mainType: "series",
            ...
            function(t) {
                ...
                b.setLayout(c(d, m, f), !0),
                t.setLayoutInfo(d),
                h(b, new _( - d.x, -d.y, r, o))
            })
        }
        function i(t, e) {
            var r, o;
        ...
        function r(t, e, i, n, r) {
            ...
            return "asc" === n ? r.splice(0, a - s) : r.splice(s, a - s),
            i
        }
        function o(t, e) {
        ...
        function a(t, e, i) {
            for (var n = 0,
            r = 0,
            o = e.length; o > r; r++) n += e[r].getValue();
            var a, s = t.get("visualDimension");
            if (e && e.length) if ("value" === s && i) a = [e[e.length - 1].getValue(), e[0].getValue()],
            "asc" === i && a.reverse();
            else {
                var a = [1 / 0, -(1 / 0)];
                f.each(e,
        ...
        function s(t, e, i) {
            ...
            o = 1 / 0,
            a = 0,
            s = t.length; s > a; a++) n = t[a].getLayout().area,
            n && (o > n && (o = n), n > r && (r = n));
            var l = t.area * t.area,
            u = e * e * i;
        ...
        function l(t, e, i, n, r) {
            ...
            l = ["width", "height"],
            u = i[s[o]],
            c = e ? t.area / e: 0; (r || c > i[l[a]]) && (c = i[l[a]]);
            for (var h = 0,
            f = t.length; f > h; h++) {
                var m = t[h],
                g = {},
        ...
        function u(t, e, i, n) {
            ...
            for (var a, s = i * n,
            l = s * t.get("zoomToNodeRatio"); a = r.parentNode;) {
                for (var u = 0,
                c = a.children,
                h = 0,
                d = c.length; d > h; h++) u += c[h].getValue();
                var p = r.getValue();
                if (0 === p) return o;
                l *= u / p;
                var f = a.getModel("itemStyle.normal").get("borderWidth");
                isFinite(f) && (l += 4 * f * f + 4 * f * Math.pow(l, .5)),
    ...
    e("echarts/chart/treemap", ["require", "../echarts", "./treemap/TreemapSeries", "./treemap/TreemapView", "./treemap/treemapAction", "./treemap/treemapVisual", "./treemap/treemapLayout"],
    function(t) {
        var e = t("../echarts");
        t("./treemap/TreemapSeries"),
        t("./treemap/TreemapView"),
        t("./treemap/treemapAction"),
        e.registerVisualCoding("chart", t("./treemap/treemapVisual")),
        e.registerLayout(t("./treemap/treemapLayout"))
    }),
    e("echarts/data/Graph", ["require", "zrender/core/util"],
    function(t) {
        function e(t, e) {
            this.id = null == t ? "": t,
            this.inEdges = [],
        ...
        o.eachNode = function(t, e) {
            ...
            n = i.length,
            r = 0; n > r; r++) i[r].dataIndex >= 0 && t.call(e, i[r], r)
        },
        o.eachEdge = function(t, e) {
            for (var i = this.edges,
            n = i.length,
            r = 0; n > r; r++) i[r].dataIndex >= 0 && i[r].node1.dataIndex >= 0 && i[r].node2.dataIndex >= 0 && t.call(e, i[r], r)
        },
        ...
        o.update = function() {
            ...
            n = this.edges,
            r = 0,
            o = i.length; o > r; r++) i[r].dataIndex = -1;
            for (var r = 0,
            o = t.count(); o > r; r++) i[t.getRawIndex(r)].dataIndex = r;
            e.filterSelf(function(t) {
                var i = n[e.getRawIndex(t)];
                return i.node1.dataIndex >= 0 && i.node2.dataIndex >= 0
            });
            for (var r = 0,
            o = n.length; o > r; r++) n[r].dataIndex = -1;
            for (var r = 0,
            o = e.count(); o > r; r++) n[e.getRawIndex(r)].dataIndex = r
        },
        ...
        return n.mixin(e, a("hostGraph", "data")),
        n.mixin(i, a("hostGraph", "edgeData")),
        r.Node = e,
        r.Edge = i,
        r
    }),
    e("echarts/chart/helper/createGraphFromNodeEdge", ["require", "../../data/List", "../../data/Graph", "../../data/helper/linkList", "../../data/helper/completeDimensions", "zrender/core/util"],
    function(t) {
        var e = t("../../data/List"),
        i = t("../../data/Graph"),
    ...
    e("echarts/chart/graph/GraphSeries", ["require", "../../data/List", "zrender/core/util", "../helper/createGraphFromNodeEdge", "../../echarts"],
    function(t) {
        var e = t("../../data/List"),
        i = t("zrender/core/util"),
        ...
        return t("../../echarts").extendSeriesModel({
            ...
            getInitialData: function(t, e) {
                ...
                if (r && i) {
                    ...
                    a = o.data,
                    s = this;
                    return a.wrapMethod("getItemModel",
                    function(t) {
            ...
            _updateCategoriesData: function() {
                var t = i.map(this.option.categories || [],
                function(t) {
    ...
    e("echarts/chart/helper/LinePath", ["require", "../../util/graphic"],
    function(t) {
        var e = t("../../util/graphic"),
        i = e.Line.prototype,
        ...
        return e.extendShape({
            ...
            buildPath: function(t, e) { (null == e.cpx1 || null == e.cpy1 ? i: n).buildPath(t, e)
            },
            pointAt: function(t) {
                var e = this.shape;
    ...
    e("echarts/chart/helper/Line", ["require", "../../util/symbol", "zrender/core/vector", "./LinePath", "../../util/graphic", "zrender/core/util", "../../util/number"],
    function(t) {
        function e(t, e, i) {
        ...
        function o() {
            ...
            if (this.__dirty || e.__dirty) {
                ...
                c = u.sub([], l, s);
                u.normalize(c, c),
                i && (i.attr("position", s), r(n) && n.attr("rotation", a(s, l))),
                n && (n.attr("position", l), r(i) && i.attr("rotation", a(l, s))),
                o.attr("position", l);
                var h, d, p;
                "end" === o.__position ? (h = [5 * c[0] + l[0], 5 * c[1] + l[1]], d = c[0] > .8 ? "left": c[0] < -.8 ? "right": "center", p = c[1] > .8 ? "top": c[1] < -.8 ? "bottom": "middle") : (h = [5 * -c[0] + s[0], 5 * -c[1] + s[1]], d = c[0] > .8 ? "right": c[0] < -.8 ? "left": "center", p = c[1] > .8 ? "bottom": c[1] < -.8 ? "top": "middle"),
                o.attr({
                    style: {
        ...
        p = t("../../util/number"),
        f = s.prototype;
        return f.beforeUpdate = o,
        f._createLine = function(t, n, r, o) {
            var a = t.hostModel,
            s = t.getItemLayout(o),
            l = i(s);
            l.shape.percent = 0,
            ...
            if (this.add(u), n) {
                ...
                this.add(c),
                this._fromSymbolType = n.getItemVisual(o, "symbol")
            }
            if (r) {
                var d = e("toSymbol", r, o);
                this.add(d),
                this._toSymbolType = r.getItemVisual(o, "symbol")
            }
        ...
        f.updateData = function(t, i, r, o) {
            ...
            if (n(u.shape, l), h.updateProps(s, u, a), i) {
                ...
                if (this._fromSymbolType !== c) {
                    ...
                    this.remove(s.childOfName("fromSymbol")),
                    this.add(d)
                }
            ...
            if (r) {
                ...
                if (p !== this._toSymbolType) {
                    ...
                    this.remove(s.childOfName("toSymbol")),
                    this.add(f)
                }
        ...
        f._updateCommonStl = function(t, e, i, n) {
            ...
            m.__textAlign = l.get("align"),
            m.__textBaseline = l.get("baseline"),
            m.__position = s.get("position"),
            h.setHoverStyle(this, a.getModel("lineStyle.emphasis").getLineStyle())
        },
        f.updateLayout = function(t, e, i, r) {
            ...
            n(a.shape, o),
            a.dirty(!0),
            e && e.getItemGraphicEl(r).attr("position", o[0]),
            i && i.getItemGraphicEl(r).attr("position", o[1])
        },
        d.inherits(s, h.Group),
        s
    }),
    e("echarts/chart/helper/LineDraw", ["require", "../../util/graphic", "./Line"],
    function(t) {
        function e(t) {
            this._ctor = t || n,
            this.group = new i.Group
    ...
    e("echarts/chart/graph/GraphView", ["require", "../helper/SymbolDraw", "../helper/LineDraw", "../../component/helper/RoamController", "../../util/model", "../../util/graphic", "../../echarts"],
    function(t) {
        var e = t("../helper/SymbolDraw"),
        i = t("../helper/LineDraw"),
        ...
        t("../../echarts").extendChartView({
            ...
            render: function(t, e, i) {
                ...
                if ("geo" === n.type || "view" === n.type) {
                    ...
                    this._firstRender ? d.attr(p) : o.updateProps(d, p, t),
                    ...
                    f && this._startForceLayoutIteration(f, m),
                    a.eachItemGraphicEl(function(t, e) {
                        var i = a.getItemModel(e).get("draggable");
                        i && f ? t.on("drag",
                        function() {
                            f.warmUp(),
                            !this._layouting && this._startForceLayoutIteration(f, m),
                            f.setFixed(e),
                            a.setItemLayout(e, t.position)
                        },
                        this).on("dragend",
                        function() {
                            f.setUnfixed(e)
    ...
    e("echarts/chart/graph/roamAction", ["require", "../../echarts", "../../action/roamHelper"],
    function(t) {
        var e = t("../../echarts"),
        ...
        function(t, e) {
            ...
            function(e) {
                ...
                e.setRoamPan && e.setRoamPan(o.x, o.y),
                e.setRoamZoom && e.setRoamZoom(o.zoom),
                n && n.setPan(o.x, o.y),
                n && n.setZoom(o.zoom)
            })
        })
    }),
    e("echarts/chart/graph/categoryFilter", ["require"],
    function(t) {
        return function(t) {
            var e = t.findComponents({
                mainType: "legend"
    ...
    e("echarts/chart/graph/categoryVisual", ["require"],
    function(t) {
        return function(t) {
    ...
    e("echarts/chart/graph/simpleLayoutHelper", ["require"],
    function(t) {
        return function(t) {
            var e = t.coordinateSystem;
            if (!e || "view" === e.type) {
    ...
    e("echarts/chart/graph/simpleLayout", ["require", "./simpleLayoutHelper"],
    function(t) {
    ...
    e("echarts/chart/graph/circularLayoutHelper", ["require"],
    function(t) {
        return function(t) {
            var e = t.coordinateSystem;
            if (!e || "view" === e.type) {
                ...
                r.eachNode(function(t) {
                    ...
                    o += s * (a ? e: 2) / 2,
                    t.setLayout([c * Math.cos(o) + l, c * Math.sin(o) + u]),
                    o += s * (a ? e: 2) / 2
                }),
    ...
    e("echarts/chart/graph/circularLayout", ["require", "./circularLayoutHelper"],
    function(t) {
    ...
    e("echarts/chart/graph/forceHelper", ["require", "zrender/core/vector"],
    function(t) {
        ...
        return function(t, n, r) {
            ...
            a = o.width,
            s = o.height,
            l = [o.x + a / 2, o.y + s / 2], u = null == r.gravity ? .1 : r.gravity, c = 0; c < t.length; c++) {
                var h = t[c];
                h.p || (h.p = e.create(a * (Math.random() - .5) + l[0], s * (Math.random() - .5) + l[1])),
                h.pp = e.clone(h.p),
                h.edges = null
            }
            var d = .6;
            return {
                ...
                step: function(r) {
                    for (var o = [], a = t.length, s = 0; s < n.length; s++) {
                        ...
                        m = p.w / (h.w + p.w);
                        e.normalize(o, o),
                        !h.fixed && i(h.p, h.p, o, m * f * d),
                        !p.fixed && i(p.p, p.p, o, -(1 - m) * f * d)
                    }
                    for (var s = 0; a > s; s++) {
                        var g = t[s];
                    ...
                    for (var s = 0; a > s; s++) for (var h = t[s], v = s + 1; a > v; v++) {
                        ...
                        var y = (h.rep + p.rep) / f / f; ! h.fixed && i(h.pp, h.pp, o, y),
                        !p.fixed && i(p.pp, p.pp, o, -y)
                    }
                    for (var _ = [], s = 0; a > s; s++) {
                        var g = t[s];
    ...
    e("echarts/chart/graph/forceLayout", ["require", "./forceHelper", "../../util/number", "./simpleLayoutHelper", "./circularLayoutHelper", "zrender/core/vector"],
    function(t) {
        var e = t("./forceHelper"),
        i = t("../../util/number"),
        ...
        return function(t, a) {
            ...
            function(t) {
                if ("force" === t.get("layout")) {
                    ...
                    _.step = function(t) {
                        for (var e = 0,
                        i = m.length; i > e; e++) m[e].fixed && o.copy(m[e].p, s.getNodeByIndex(e).getLayout());
                        x(function(e, i, n) {
                            for (var r = 0,
                            o = e.length; o > r; r++) e[r].fixed || s.getNodeByIndex(r).setLayout(e[r].p),
                            a[l.getId(r)] = e[r].p;
                            for (var r = 0,
                            o = i.length; o > r; r++) {
                                var u = i[r],
                                ...
                                h = u.n2.p,
                                d = [c, h];
                                u.curveness > 0 && d.push([(c[0] + h[0]) / 2 - (c[1] - h[1]) * u.curveness, (c[1] + h[1]) / 2 - (h[0] - c[0]) * u.curveness]),
                                s.getEdgeByIndex(r).setLayout(d)
                            }
                            t && t(n)
                        })
                    },
    ...
    e("echarts/chart/graph/createView", ["require", "../../coord/View", "../../util/layout", "zrender/core/bbox"],
    function(t) {
        function e(t, e, i) {
        ...
        return function(t, n) {
            ...
            function(t) {
                ...
                if (!o || "view" === o) {
                    ...
                    c = [];
                    r.fromPoints(l, u, c);
                    var h = e(t, n, (c[0] - u[0]) / (c[1] - u[1]) || 1); (isNaN(u[0]) || isNaN(u[1])) && (u = [h.x, h.y], c = [h.x + h.width, h.y + h.height]);
                    var d = c[0] - u[0],
                    p = c[1] - u[1],
                    f = h.width,
                    m = h.height;
                    a = t.coordinateSystem = new i,
                    a.setBoundingRect(u[0], u[1], d, p),
                    a.setViewRect(h.x, h.y, f, m);
                    var g = t.getModel("roamDetail");
                    a.setPan(g.get("x") || 0, g.get("y") || 0),
                    a.setZoom(g.get("zoom") || 1)
                }
            })
        }
    }),
    e("echarts/chart/graph", ["require", "../echarts", "zrender/core/util", "./graph/GraphSeries", "./graph/GraphView", "./graph/roamAction", "./graph/categoryFilter", "../visual/symbol", "./graph/categoryVisual", "./graph/simpleLayout", "./graph/circularLayout", "./graph/forceLayout", "./graph/createView"],
    function(t) {
        var e = t("../echarts"),
        i = t("zrender/core/util");
        t("./graph/GraphSeries"),
        t("./graph/GraphView"),
        t("./graph/roamAction"),
        e.registerProcessor("filter", t("./graph/categoryFilter")),
        e.registerVisualCoding("chart", i.curry(t("../visual/symbol"), "graph", "circle", null)),
        e.registerVisualCoding("chart", t("./graph/categoryVisual")),
        e.registerLayout(t("./graph/simpleLayout")),
        e.registerLayout(t("./graph/circularLayout")),
        e.registerLayout(t("./graph/forceLayout")),
        e.registerCoordinateSystem("graphView", {
            create: t("./graph/createView")
        })
    }),
    e("echarts/chart/gauge/GaugeSeries", ["require", "../../data/List", "../../model/Series", "zrender/core/util"],
    function(t) {
        var e = t("../../data/List"),
        i = t("../../model/Series"),
        n = t("zrender/core/util"),
    ...
    e("echarts/chart/gauge/PointerPath", ["require", "zrender/graphic/Path"],
    function(t) {
        return t("zrender/graphic/Path").extend({
            ...
            buildPath: function(t, e) {
                ...
                a = e.angle - Math.PI / 2,
                t.moveTo(s, l),
                t.lineTo(e.x + i(a) * o, e.y + n(a) * o),
                t.lineTo(e.x + i(e.angle) * r, e.y + n(e.angle) * r),
                t.lineTo(e.x - i(a) * o, e.y - n(a) * o),
                t.lineTo(s, l)
            }
        })
    }),
    e("echarts/chart/gauge/GaugeView", ["require", "./PointerPath", "../../util/graphic", "../../util/number", "../../view/Chart"],
    function(t) {
        function e(t, e) {
            var i = t.get("center"),
            n = e.getWidth(),
        ...
        function i(t, e) {
            return e && ("string" == typeof e ? t = e.replace("{value}", t) : "function" == typeof e && (t = e(t))),
            t
        }
        var n = t("./PointerPath"),
        r = t("../../util/graphic"),
        ...
        l = t("../../view/Chart").extend({
            ...
            _renderMain: function(t, e, i, n, o) {
                ...
                l = t.getModel("axisLine"), u = l.getModel("lineStyle"), c = t.get("clockwise"), h = -t.get("startAngle") / 180 * Math.PI, d = -t.get("endAngle") / 180 * Math.PI, p = (d - h) % s, f = h, m = u.get("width"), g = 0; g < n.length; g++) {
                    var d = h + p * n[g][0],
                    v = new r.Sector({
                        shape: {
                            startAngle: f,
                    ...
                    v.setStyle(u.getLineStyle(["color", "borderWidth", "borderColor"])),
                    a.add(v),
                    f = d
                }
                var y = function(t) {
                ...
                this._renderTicks(t, e, i, y, o, h, d, c),
                this._renderPointer(t, e, i, y, o, h, d, c),
            ...
            _renderTicks: function(t, e, n, a, s, l, u, c) {
                ...
                p = s.cy,
                f = s.r,
                m = t.get("min"), g = t.get("max"), v = t.getModel("splitLine"), y = t.getModel("axisTick"), _ = t.getModel("axisLabel"), x = t.get("splitNumber"), b = y.get("splitNumber"), w = v.get("length"), M = y.get("length"), S = l, L = (u - l) / x, C = L / b, T = v.getModel("lineStyle").getLineStyle(), P = y.getModel("lineStyle").getLineStyle(), A = _.getModel("textStyle"), D = 0; x >= D; D++) {
                    var z = Math.cos(S),
                    I = Math.sin(S);
                    if (v.get("show")) {
                        var k = new r.Line({
            ...
            _renderPointer: function(t, e, i, s, l, u, c, h) {
                ...
                m.eachItemGraphicEl(function(t, e) {
                    ...
                    "auto" === t.style.fill && t.setStyle("fill", s((m.get("value", e) - p[0]) / (p[1] - p[0]))),
                    r.setHoverStyle(t, i.getModel("itemStyle.emphasis").getItemStyle())
                }),
                this._data = m
            },
            ...
            _renderDetail: function(t, e, n, o, s) {
                ...
                if (l.get("show")) {
                    ...
                    "auto" === y.style.textFill && y.setStyle("textFill", o((v - u) / (c - u))),
                    y.setStyle(l.getItemStyle(["color"])),
                    this.group.add(y)
                }
            }
        });
    ...
    e("echarts/chart/gauge", ["require", "./gauge/GaugeSeries", "./gauge/GaugeView"],
    function(t) {
        t("./gauge/GaugeSeries"),
        t("./gauge/GaugeView")
    }),
    e("echarts/chart/funnel/FunnelSeries", ["require", "../../data/List", "../../util/model", "../../data/helper/completeDimensions", "../../echarts"],
    function(t) {
        var e = t("../../data/List"),
        i = t("../../util/model"),
    ...
    e("echarts/chart/funnel/FunnelView", ["require", "../../util/graphic", "zrender/core/util", "../../view/Chart"],
    function(t) {
        function e(t, e) {
            function i() {
                a.ignore = a.hoverIgnore,
            ...
            this.add(s),
            this.updateData(t, e, !0),
            this.on("emphasis", i).on("normal", r).on("mouseover", i).on("mouseout", r)
        }
        function i(t, e, i, n) {
            var r = n.getModel("textStyle"),
            o = n.get("position"),
        ...
        o.updateData = function(t, e, i) {
            ...
            h.getModel("normal").getItemStyle())),
        ...
        o._updateLabel = function(t, e) {
            ...
            p = s.getModel("labelLine.normal"),
            f = s.getModel("labelLine.emphasis");
            o.setStyle(i(t, e, "normal", h)),
            o.ignore = o.normalIgnore = !h.get("show"),
            o.hoverIgnore = !d.get("show"),
            r.ignore = r.normalIgnore = !p.get("show"),
            r.hoverIgnore = !f.get("show"),
            r.setStyle({
                stroke: c
            }),
            r.setStyle(p.getModel("lineStyle").getLineStyle()),
            o.hoverStyle = i(t, e, "emphasis", d),
            r.hoverStyle = f.getModel("lineStyle").getLineStyle()
        },
    ...
    e("echarts/chart/funnel/funnelLayout", ["require", "../../util/layout", "../../util/number"],
    function(t) {
        function e(t, e) {
    ...
    e("echarts/chart/funnel", ["require", "zrender/core/util", "../echarts", "./funnel/FunnelSeries", "./funnel/FunnelView", "../visual/dataColor", "./funnel/funnelLayout", "../processor/dataFilter"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../echarts");
        ...
        i.registerLayout(t("./funnel/funnelLayout")),
        i.registerProcessor("filter", e.curry(t("../processor/dataFilter"), "funnel"))
    }),
    e("echarts/coord/parallel/ParallelAxis", ["require", "zrender/core/util", "../Axis"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../Axis"),
        n = function(t, e, n, r, o) {
    ...
    e("echarts/coord/parallel/Parallel", ["require", "../../util/layout", "../../coord/axisHelper", "zrender/core/util", "./ParallelAxis", "zrender/core/matrix", "zrender/core/vector"],
    function(t) {
        function e(t, e, i) {
            this._axesMap = {},
            this._axesLayout = {},
        ...
        return e.prototype = {
            ...
            _init: function(t, e, i) {
                ...
                function(t, i) {
                    ...
                    u = "category" === l.type;
                    l.onBand = u && s.get("boundaryGap"),
                    l.inverse = s.get("inverse"),
                    s.axis = l,
                    l.model = s
                },
                this),
            ...
            _layoutAxes: function(t) {
                ...
                function(t) {
                    var e = t.inverse ? 1 : 0;
                    t.setExtent(p[e], p[1 - e]),
                    n.niceScaleExtent(t, t.model)
                }),
                l(o,
                function(t, n) {
            ...
            eachActiveState: function(t, e, i) {
                ...
                o = !1,
                a = 0,
                s = n.length; s > a; a++)"normal" !== r[n[a]].model.getActiveState() && (o = !0);
                for (var l = 0,
                u = t.count(); u > l; l++) {
            ...
            axisCoordToPoint: function(t, e) {
                ...
                n = [t, 0];
                return s.applyTransform(n, n, i.transform),
                n
            },
    ...
    e("echarts/coord/parallel/parallelCreator", ["require", "./Parallel", "../../CoordinateSystem"],
    function(t) {
        function e(t, e) {
            var n = [];
    ...
    e("echarts/coord/parallel/AxisModel", ["require", "../../model/Component", "zrender/core/util", "../../model/mixin/makeStyleMapper", "../axisModelCreator", "../../util/number", "../axisModelCommonMixin"],
    function(t) {
        function e(t, e) {
            return e.type || (e.data ? "category": "value")
        }
        ...
        s = i.extend({
            ...
            getActiveState: function(t) {
                ...
                for (var i = 0,
                n = e.length; n > i; i++) if (e[i][0] <= t && t <= e[i][1]) return "active";
                return "inactive"
            }
        }),
        l = {
        ...
        return n.merge(s.prototype, t("../axisModelCommonMixin")),
        o("parallel", s, e, l),
        s
    }),
    e("echarts/coord/parallel/ParallelModel", ["require", "zrender/core/util", "../../model/Component", "./AxisModel"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../model/Component");
        t("./AxisModel"),
        i.extend({
            ...
            _initDimensions: function() {
                ...
                n = e.filter(this.dependentModels.parallelAxis,
                function(t) {
    ...
    e("echarts/component/axis/parallelAxisAction", ["require", "../../echarts"],
    function(t) {
        var e = t("../../echarts"),
        i = {
            type: "axisAreaSelect",
    ...
    e("echarts/component/helper/SelectController", ["require", "zrender/mixin/Eventful", "zrender/core/util", "../../util/graphic"],
    function(t) {
        function e(t, e, i) {
            f.call(this),
            this.type = t,
        ...
        function s(t, e) {
            ...
            if (i.call(this, n, r)) {
                ...
                u.call(this, o),
                this.trigger("selected", m.clone(o)),
                e && this.trigger("selectEnd", m.clone(o))
            }
        }
        function l() {
            var t = this._track;
    ...
    e("echarts/component/axis/ParallelAxisView", ["require", "zrender/core/util", "./AxisBuilder", "../helper/SelectController", "../../echarts"],
    function(t) {
        function e(t, e, i) {
        ...
        a = t("../../echarts").extendComponentView({
            ...
            render: function(t, r, a, s) {
                if (!e(t, r, s) && (this.axisModel = t, this.api = a, this.group.removeAll(), t.get("show"))) {
                    ...
                    var f = p.getGroup();
                    this.group.add(f),
                    this._buildSelectController(f, u, t, a)
                }
            },
            _buildSelectController: function(t, e, n, o) {
                var a = n.axis,
                s = this._selectController;
                s || (s = this._selectController = new r("line", o.getZr(), e), s.on("selected", i.bind(this._onSelected, this))),
                s.enable(t);
                var l = i.map(n.activeIntervals,
                function(t) {
    ...
    e("echarts/component/parallelAxis", ["require", "../coord/parallel/parallelCreator", "./axis/parallelAxisAction", "./axis/ParallelAxisView"],
    function(t) {
        t("../coord/parallel/parallelCreator"),
        t("./axis/parallelAxisAction"),
        t("./axis/ParallelAxisView")
    }),
    e("echarts/coord/parallel/parallelPreprocessor", ["require", "zrender/core/util", "../../util/model"],
    function(t) {
        function e(t) {
            if (!t.parallel) {
                var e = !1;
    ...
    e("echarts/component/parallel", ["require", "../coord/parallel/parallelCreator", "../coord/parallel/ParallelModel", "./parallelAxis", "../echarts", "../coord/parallel/parallelPreprocessor"],
    function(t) {
        t("../coord/parallel/parallelCreator"),
    ...
    e("echarts/chart/parallel/ParallelSeries", ["require", "../../data/List", "zrender/core/util", "../../model/Series"],
    function(t) {
        function e(t, e, i) {
            var r = t.get("data"),
            o = +e.replace("dim", "");
    ...
    e("echarts/chart/parallel/ParallelView", ["require", "../../util/graphic", "zrender/core/util", "../../view/Chart"],
    function(t) {
        function e(t, e, i) {
            var n = t.model,
            r = t.getRect(),
        ...
        s = t("../../view/Chart").extend({
            ...
            render: function(t, r, s, l) {
                ...
                m = t.coordinateSystem,
                g = m.dimensions;
                p.diff(f).add(u).update(c).remove(h).execute(),
                ...
                this._data || d.setClipPath(e(m, t,
                function() {
                    d.removeClipPath()
                })),
                this._data = p
    ...
    e("echarts/chart/parallel/parallelVisual", ["require"],
    function(t) {
        return function(t, e) {
    ...
    e("echarts/chart/parallel", ["require", "../echarts", "../component/parallel", "./parallel/ParallelSeries", "./parallel/ParallelView", "./parallel/parallelVisual"],
    function(t) {
        var e = t("../echarts");
        t("../component/parallel"),
        t("./parallel/ParallelSeries"),
        t("./parallel/ParallelView"),
        e.registerVisualCoding("chart", t("./parallel/parallelVisual"))
    }),
    e("echarts/chart/sankey/SankeySeries", ["require", "../../model/Series", "../helper/createGraphFromNodeEdge"],
    function(t) {
        var e = t("../../model/Series"),
    ...
    e("echarts/chart/sankey/SankeyView", ["require", "../../util/graphic", "../../util/model", "zrender/core/util", "../../echarts"],
    function(t) {
        function e(t, e, n) {
            var r = new i.Rect({
                shape: {
        ...
        return t("../../echarts").extendChartView({
            ...
            render: function(t, a, s) {
                ...
                l.eachNode(function(e) {
                    ...
                    o.getModel("itemStyle.normal").getItemStyle())),
                    i.setHoverStyle(h, r.extend(e.getModel("itemStyle.emphasis"), {
                ...
                l.eachEdge(function(t) {
                    ...
                    e.setStyle(n.getItemStyle()),
                    i.setHoverStyle(e, t.getModel("lineStyle.emphasis").getItemStyle()),
                    u.add(e)
                }),
                this._data || u.setClipPath(e(u.getBoundingRect(), t,
                function() {
                    u.removeClipPath()
                })),
    ...
    e("echarts/util/array/nest", ["require", "zrender/core/util"],
    function(t) {
        function e() {
            function t(e, r) {
    ...
    e("echarts/chart/sankey/sankeyLayout", ["require", "../../util/layout", "../../util/array/nest", "zrender/core/util"],
    function(t) {
        function e(t, e) {
        ...
        function u(t, e, i) {
            ...
            function(t) {
                ...
                if (r = a - e - i, r > 0) {
                    ...
                    !0), a = n.getLayout().y, o = s - 2; o >= 0; --o) n = t[o],
                    r = n.getLayout().y + n.getLayout().dy + e - a,
                    r > 0 && (l = n.getLayout().y - r, n.setLayout({
                        y: l
                    },
                    !0)),
                    a = n.getLayout().y
        ...
        function v(t, e) {
            ...
            r = t.length,
            o = -1;
            if (1 === arguments.length) for (; ++o < r;) i = +t[o],
            isNaN(i) || (n += i);
            else for (; ++o < r;) i = +e.call(t, t[o], o),
            isNaN(i) || (n += i);
            return n
        }
        function y(t) {
    ...
    e("echarts/chart/sankey/sankeyVisual", ["require", "../../visual/VisualMapping"],
    function(t) {
    ...
    e("echarts/chart/sankey", ["require", "../echarts", "./sankey/SankeySeries", "./sankey/SankeyView", "./sankey/sankeyLayout", "./sankey/sankeyVisual"],
    function(t) {
        var e = t("../echarts");
        t("./sankey/SankeySeries"),
        t("./sankey/SankeyView"),
        e.registerLayout(t("./sankey/sankeyLayout")),
        e.registerVisualCoding("chart", t("./sankey/sankeyVisual"))
    }),
    e("echarts/chart/helper/WhiskerBoxDraw", ["require", "zrender/core/util", "../../util/graphic", "zrender/graphic/Path"],
    function(t) {
        function e(t, e, i, n) {
            a.Group.call(this),
            this.bodyIndex,
        ...
        u.updateData = function(t, e, i) {
            ...
            r),
            s(this.childAt(this.whiskerIndex), {
    ...
    e("echarts/chart/helper/whiskerBoxCommon", ["require", "../../data/List", "../../data/helper/completeDimensions", "../helper/WhiskerBoxDraw"],
    function(t) {
        function e(t) {
        ...
        o = {
            ...
            getInitialData: function(t, r) {
                ...
                u = s.get("type"),
                c = l.get("type");
                "category" === u ? (t.layout = "horizontal", o = s.getCategories(), a = !0) : "category" === c ? (t.layout = "vertical", o = l.getCategories(), a = !0) : t.layout = t.layout || "horizontal",
                this._baseAxisDim = "horizontal" === t.layout ? "x": "y";
                var h = t.data,
                d = this.dimensions = ["base"].concat(this.valueDimensions);
                n(d, h);
                var p = new i(d, this);
                return p.initData(h, o ? o.slice() : null,
                function(t, i, n, r) {
                    var o = e(t);
    ...
    e("echarts/chart/boxplot/BoxplotSeries", ["require", "zrender/core/util", "../../model/Series", "../helper/whiskerBoxCommon"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../model/Series"),
    ...
    e("echarts/chart/boxplot/BoxplotView", ["require", "zrender/core/util", "../../view/Chart", "../../util/graphic", "../helper/whiskerBoxCommon"],
    function(t) {
        function e(t, e, i) {
    ...
    e("echarts/chart/boxplot/boxplotVisual", ["require"],
    function(t) {
    ...
    e("echarts/chart/boxplot/boxplotLayout", ["require", "zrender/core/util", "../../util/number"],
    function(t) {
        function e(t) {
            var e = [],
            i = [];
        ...
        function i(t) {
            ...
            function(t, e) {
                c.push(g),
                g += f + m,
                u.push(Math.min(Math.max(m, h[e][0]), h[e][1]))
            })
        }
        function n(t, e, i) {
            var n = t.coordinateSystem,
            ...
            function() {
                function t(t) {
                    ...
                    i[f] = t;
                    var r;
                    return isNaN(h) || isNaN(t) ? r = [NaN, NaN] : (r = n.dataToPoint(i), r[p] += e),
                    r
                }
                function i(t, e) {
                    var i = t.slice(),
    ...
    e("echarts/chart/boxplot", ["require", "../echarts", "./boxplot/BoxplotSeries", "./boxplot/BoxplotView", "./boxplot/boxplotVisual", "./boxplot/boxplotLayout"],
    function(t) {
        var e = t("../echarts");
        t("./boxplot/BoxplotSeries"),
        t("./boxplot/BoxplotView"),
        e.registerVisualCoding("chart", t("./boxplot/boxplotVisual")),
        e.registerLayout(t("./boxplot/boxplotLayout"))
    }),
    e("echarts/chart/candlestick/CandlestickSeries", ["require", "zrender/core/util", "../../model/Series", "../helper/whiskerBoxCommon", "../../util/format"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../model/Series"),
        n = t("../helper/whiskerBoxCommon"),
    ...
    e("echarts/chart/candlestick/CandlestickView", ["require", "zrender/core/util", "../../view/Chart", "../../util/graphic", "../helper/whiskerBoxCommon"],
    function(t) {
        function e(t, e, i) {
            var n = e.getItemModel(i),
            o = n.getModel(s),
    ...
    e("echarts/chart/candlestick/preprocessor", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util");
        return function(t) {
            t && e.isArray(t.series) && e.each(t.series,
            function(t) {
                e.isObject(t) && "k" === t.type && (t.type = "candlestick")
            })
        }
    }),
    e("echarts/chart/candlestick/candlestickVisual", ["require"],
    function(t) {
        var e = ["itemStyle", "normal", "borderColor"],
    ...
    e("echarts/chart/candlestick/candlestickLayout", ["require"],
    function(t) {
        function e(t, e) {
            ...
            function(t) {
                ...
                function() {
                    function t(t) {
                        ...
                        return e[h] = u,
                        e[d] = t,
                        isNaN(u) || isNaN(t) ? [NaN, NaN] : i.dataToPoint(e)
                    }
                    function e(t, e) {
                        var i = t.slice(),
                        n = t.slice();
    ...
    e("echarts/chart/candlestick", ["require", "../echarts", "./candlestick/CandlestickSeries", "./candlestick/CandlestickView", "./candlestick/preprocessor", "./candlestick/candlestickVisual", "./candlestick/candlestickLayout"],
    function(t) {
        var e = t("../echarts");
        t("./candlestick/CandlestickSeries"),
        t("./candlestick/CandlestickView"),
        e.registerPreprocessor(t("./candlestick/preprocessor")),
        e.registerVisualCoding("chart", t("./candlestick/candlestickVisual")),
        e.registerLayout(t("./candlestick/candlestickLayout"))
    }),
    e("echarts/chart/effectScatter/EffectScatterSeries", ["require", "../helper/createListFromArray", "../../model/Series"],
    function(t) {
        var e = t("../helper/createListFromArray"),
        i = t("../../model/Series");
        return i.extend({
    ...
    e("echarts/chart/helper/EffectSymbol", ["require", "zrender/core/util", "../../util/symbol", "../../util/graphic", "../../util/number", "./Symbol"],
    function(t) {
        function e(t) {
        ...
        c.updateData = function(t, i) {
            function n() {
                b.trigger("emphasis"),
                "render" !== f && this.startEffectAnimation(v, g, m, y, _, x)
            }
            function r() {
                b.trigger("normal"),
                "render" !== f && this.stopEffectAnimation()
            }
            var o = t.hostModel;
            ...
            if (d) {
                var p = s.position;
                p[0] = a.parsePercent(d[0], c[0]),
                p[1] = a.parsePercent(d[1], c[1])
            }
            this._symbolType = u,
            this._color = h;
    ...
    e("echarts/chart/effectScatter/EffectScatterView", ["require", "../helper/SymbolDraw", "../helper/EffectSymbol", "../../echarts"],
    function(t) {
        var e = t("../helper/SymbolDraw"),
    ...
    e("echarts/chart/effectScatter", ["require", "zrender/core/util", "../echarts", "./effectScatter/EffectScatterSeries", "./effectScatter/EffectScatterView", "../visual/symbol", "../layout/points"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../echarts");
        t("./effectScatter/EffectScatterSeries"),
        t("./effectScatter/EffectScatterView"),
        i.registerVisualCoding("chart", e.curry(t("../visual/symbol"), "effectScatter", "circle", null)),
        i.registerLayout(e.curry(t("../layout/points"), "effectScatter"))
    }),
    e("echarts/chart/lines/LinesSeries", ["require", "../../model/Series", "../../data/List", "zrender/core/util"],
    function(t) {
        var e = t("../../model/Series"),
        i = t("../../data/List"),
        n = t("zrender/core/util");
        return e.extend({
            ...
            getInitialData: function(t, e) {
                ...
                function(t) {
                    o.push(t[0]),
                    a.push(t[1]),
                    s.push(n.extend(n.extend({},
                    n.isArray(t[0]) ? null: t[0]), n.isArray(t[1]) ? null: t[1]))
                });
    ...
    e("echarts/chart/helper/EffectLine", ["require", "../../util/graphic", "./Line", "zrender/core/util", "../../util/symbol", "zrender/core/curve"],
    function(t) {
        function e(t, e, i, n) {
            r.Group.call(this);
            var a = new o(t, e, i, n);
        ...
        function n() {
            ...
            u = a(t[1], i[1], e[1], n);
            this.rotation = -Math.atan2(u, s) - Math.PI / 2,
            this.ignore = !1
        }
        ...
        return u._updateEffectSymbol = function(t, e) {
            ...
            h = this.childAt(1),
            d = 1e3 * o.get("period"); (this._symbolType !== u || d !== this._period) && (h = s.createSymbol(u, -.5, -.5, 1, 1, c), h.ignore = !0, h.z2 = 100, this._symbolType = u, this._period = d, this.add(h), h.__t = 0, h.animate("", !0).when(d, {
                __t: 1
            }).delay(e / t.count() * d / 2).during(a.bind(n, h)).start()),
            h.setStyle("shadowColor", c),
            h.setStyle(o.getItemStyle(["color"])),
            h.attr("scale", l);
        ...
        u.updateData = function(t, e, i, n) {
            this.childAt(0).updateData(t, e, i, n),
            this._updateEffectSymbol(t, n)
        },
        ...
        a.inherits(e, r.Group),
        e
    }),
    e("echarts/chart/lines/LinesView", ["require", "../helper/LineDraw", "../helper/EffectLine", "../helper/Line", "../../echarts"],
    function(t) {
    ...
    e("echarts/chart/lines/linesLayout", ["require"],
    function(t) {
        return function(t) {
            t.eachSeriesByType("lines",
            function(t) {
                var e = t.coordinateSystem,
                i = t.fromData,
                n = t.toData,
                ...
                r.each(function(t) {
                    ...
                    s > 0 && (e = [(o[0] + a[0]) / 2 - (o[1] - a[1]) * s, (o[1] + a[1]) / 2 - (a[0] - o[0]) * s]),
                    r.setItemLayout(t, [o, a, e])
                })
            })
        }
    }),
    e("echarts/chart/lines", ["require", "./lines/LinesSeries", "./lines/LinesView", "zrender/core/util", "../echarts", "./lines/linesLayout", "../visual/seriesColor"],
    function(t) {
        t("./lines/LinesSeries"),
        t("./lines/LinesView");
        var e = t("zrender/core/util"),
        i = t("../echarts");
        i.registerLayout(t("./lines/linesLayout")),
        i.registerVisualCoding("chart", e.curry(t("../visual/seriesColor"), "lines", "lineStyle"))
    }),
    e("echarts/chart/heatmap/HeatmapSeries", ["require", "../../model/Series", "../helper/createListFromArray"],
    function(t) {
        var e = t("../../model/Series"),
        i = t("../helper/createListFromArray");
        return e.extend({
    ...
    e("echarts/chart/heatmap/HeatmapLayer", ["require", "zrender/core/util"],
    function(t) {
        function e() {
        ...
        return e.prototype = {
            update: function(t, e, r, o, a, s) {
                ...
                for (var b = p.getImageData(0, 0, d.width, d.height), w = b.data, M = 0, S = w.length; S > M;) {
                    ...
                    if (x > 0) {
                        ...
                        w[M++] = C[L + 1],
                        w[M++] = C[L + 2],
                        w[M++] *= this.opacity * C[L + 3]
                    } else M += 4
                }
                return p.putImageData(b, 0, 0),
                d
            },
            _getBrush: function() {
                ...
                return o.clearRect(0, 0, n, n),
                o.shadowOffsetX = n,
                o.shadowBlur = this.blurSize,
                o.shadowColor = "#000",
                o.beginPath(),
                o.arc( - e, e, i, 0, 2 * Math.PI, !0),
                o.closePath(),
                o.fill(),
                t
            },
            _getGradient: function(t, e, i) {
                ...
                r = n[i] || (n[i] = new Uint8ClampedArray(1024)), o = [], a = 0, s = 0; 256 > s; s++) e[i](s / 255, !0, o),
                r[a++] = o[0],
                r[a++] = o[1],
                r[a++] = o[2],
                r[a++] = o[3];
    ...
    e("echarts/chart/heatmap/HeatmapView", ["require", "../../util/graphic", "./HeatmapLayer", "zrender/core/util", "../../echarts"],
    function(t) {
        function e(t, e, i) {
            var n = t[1] - t[0];
            e = o.map(e,
            ...
            _renderOnCartesian: function(t, e, i) {
                ...
                function(i, r, o, c) {
                    ...
                    if (!isNaN(o)) {
                        ...
                        _ = "-";
                        y && null != y[2] && (_ = y[2]),
                        g.get("show") && (n.setText(f, g), f.text = e.getFormattedLabel(c, "normal") || _),
                        v.get("show") && (n.setText(m, v), m.text = e.getFormattedLabel(c, "emphasis") || _),
                        p.setStyle(f),
                        n.setHoverStyle(p, m),
                        a.add(p),
                        u.setItemGraphicEl(c, p)
                    }
                })
            },
    ...
    e("echarts/chart/heatmap", ["require", "./heatmap/HeatmapSeries", "./heatmap/HeatmapView"],
    function(t) {
        t("./heatmap/HeatmapSeries"),
        t("./heatmap/HeatmapView")
    }),
    e("echarts/component/geo/GeoView", ["require", "../helper/MapDraw", "../../echarts"],
    function(t) {
    ...
    e("echarts/component/geo", ["require", "../coord/geo/geoCreator", "./geo/GeoView", "../action/geoRoam"],
    function(t) {
        t("../coord/geo/geoCreator"),
        t("./geo/GeoView"),
        t("../action/geoRoam")
    }),
    e("echarts/component/title", ["require", "../echarts", "../util/graphic", "../util/layout"],
    function(t) {
        var e = t("../echarts"),
        i = t("../util/graphic"),
        n = t("../util/layout");
    ...
    e("echarts/component/dataZoom/typeDefaulter", ["require", "../../model/Component"],
    function(t) {
        t("../../model/Component").registerSubTypeDefaulter("dataZoom",
        function(t) {
            return "slider"
        })
    }),
    e("echarts/component/dataZoom/AxisProxy", ["require", "zrender/core/util", "../../util/number"],
    function(t) {
        function e(t, e) {
        ...
        function i(t, e, i) {
            ...
            function(t) {
                var a, s = c[t],
                l = !0;
                n(s) && (a = u[t], n(a) && (a = r[t]), s = o.linearMap(a, r, e, !0), l = !1),
                i && (s = Math[h[t]](s)),
                l && (a = o.linearMap(s, e, r, !0)),
                c[t] = s,
                u[t] = a
            }),
            {
        ...
        return l.prototype = {
            ...
            filterData: function(t) {
                ...
                if (t === this._model) {
                    ...
                    t.get("$fromToolbox") && s && "category" === s.get("type") && (r = "empty"),
                    a(n,
                    function(t) {
                        var n = t.getData();
                        n && a(t.getDimensionsOnAxis(i),
                        function(i) {
    ...
    e("echarts/component/dataZoom/DataZoomModel", ["require", "zrender/core/util", "zrender/core/env", "../../echarts", "../../util/model", "./AxisProxy"],
    function(t) {
        var e = t("zrender/core/util"),
        ...
        return n.extendComponentModel({
            ...
            mergeOption: function(t, n) {
                var r = this.option;
                t && e.merge(r, t),
                i.canvasSupported || (r.realtime = !1),
            ...
            _autoSetAxisIndex: function() {
                ...
                t && s(function(e) {
                    if (t) {
                        ...
                        a = r.length; a > o; o++)"category" === r[o].get("type") && i.push(o);
                        n[e.axisIndex] = i,
                        i.length && (t = !1)
                    }
                },
            ...
            setRawRange: function(t) {
                a(["start", "end", "startValue", "endValue"],
                function(e) {
                    this.option[e] = t[e]
                },
                this)
    ...
    e("echarts/component/dataZoom/DataZoomView", ["require", "../../view/Component"],
    function(t) {
    ...
    e("echarts/component/dataZoom/SliderZoomModel", ["require", "./DataZoomModel"],
    function(t) {
        ...
        return t.throttle = function(t, e, i, n) {
            function r(r) {
                ...
                var f = function() {
                    ...
                    o = l - (n ? u: c) - e,
                    clearTimeout(h),
                    n ? i ? h = setTimeout(p, e) : o >= 0 && p() : o >= 0 ? p() : i && (h = setTimeout(p, -o)),
                    u = l
                };
    ...
    e("echarts/component/helper/sliderMove", ["require"],
    function(t) {
        return function(t, e, i, n, r) {
            function o(t, e, i) {
    ...
    e("echarts/component/dataZoom/SliderZoomView", ["require", "zrender/core/util", "../../util/graphic", "../../util/throttle", "./DataZoomView", "../../util/number", "../../util/layout", "../helper/sliderMove"],
    function(t) {
        function e(t) {
            return "x" === t ? "y": "x"
        }
        ...
        return o.extend({
            ...
            render: function(t, e, i, n) {
                ...
                this._halfHandleSize = p(t.get("handleSize") / 2),
            ...
            _resetLocation: function() {
                ...
                i.each(u.getLayoutParams(t.option),
                function(t, e) {
                    "auto" !== t && (o[e] = t)
                });
                ...
                this._orient === x && this._size.reverse()
            },
            ...
            _updateInterval: function(t, e) {
                ...
                c(e, i, n, "all" === t || this.dataZoomModel.get("zoomLock") ? "rigid": "cross", t),
                this._range = h(l(i, n, [0, 100], !0))
            },
            ...
            _formatLabel: function(t, e) {
                ...
                i.isString(r) && (t = r.replace("{value}", t)),
                t
            },
    ...
    e("echarts/component/dataZoom/InsideZoomModel", ["require", "./DataZoomModel"],
    function(t) {
        var e = t("./DataZoomModel");
        return e.extend({
    ...
    e("echarts/component/dataZoom/InsideZoomView", ["require", "./DataZoomView", "../../util/throttle", "zrender/core/util", "../helper/sliderMove", "../../component/helper/RoamController"],
    function(t) {
        function e(t, e, i, r) {
            e = e.slice();
        ...
        return o.extend({
            ...
            _resetController: function(t) {
                ...
                function(i) {
                    ...
                    r = e[n];
                    r || (r = e[n] = new u(t.getZr()), r.enable(), r.on("pan", c(this._onPan, this, r, i)), r.on("zoom", c(this._onZoom, this, r, i))),
                    r.rect = i.model.coordinateSystem.getRect().clone()
                },
                this)
            },
    ...
    e("echarts/component/dataZoom/dataZoomProcessor", ["require", "../../echarts", "../../util/number"],
    function(t) {
        function e(t, e, i, n) {
            var o = t.name,
            ...
            u.setMin && u.setMin(c || p ? h.min: +l[0].toFixed(d)),
            u.setMax && u.setMax(c || p ? h.max: +l[1].toFixed(d))
        }
        function i(t, e, i, n) {
    ...
    e("echarts/component/dataZoom/dataZoomAction", ["require", "zrender/core/util", "../../util/model", "../../echarts"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../util/model"),
        n = t("../../echarts");
        ...
        function(t, n) {
            var r = i.createLinkedNodesFinder(e.bind(n.eachComponent, n, "dataZoom"), i.eachAxisDim,
            function(t, e) {
    ...
    e("echarts/component/dataZoom", ["require", "./dataZoom/typeDefaulter", "./dataZoom/DataZoomModel", "./dataZoom/DataZoomView", "./dataZoom/SliderZoomModel", "./dataZoom/SliderZoomView", "./dataZoom/InsideZoomModel", "./dataZoom/InsideZoomView", "./dataZoom/dataZoomProcessor", "./dataZoom/dataZoomAction"],
    function(t) {
    ...
    e("echarts/component/visualMap/preprocessor", ["require", "zrender/core/util"],
    function(t) {
        function e(t, e) {
    ...
    e("echarts/component/visualMap/typeDefaulter", ["require", "../../model/Component"],
    function(t) {
        t("../../model/Component").registerSubTypeDefaulter("visualMap",
        function(t) {
            return t.categories || (t.pieces ? t.pieces.length > 0 : t.splitNumber > 0) && !t.calculable ? "piecewise": "continuous"
        })
    }),
    e("echarts/component/visualMap/visualCoding", ["require", "../../echarts", "../../visual/VisualMapping", "zrender/core/util"],
    function(t) {
        function e(t, e) {
            var i = t.targetVisuals,
            o = {};
            r.each(["inRange", "outOfRange"],
            function(t) {
        ...
        r = t("zrender/core/util");
        i.registerVisualCoding("component",
        function(t) {
            t.eachComponent("visualMap",
            function(i) {
                e(i, t)
            })
        })
    }),
    e("echarts/visual/visualDefault", ["require", "zrender/core/util"],
    function(t) {
        var e = t("zrender/core/util"),
        i = {
            get: function(t, i, r) {
    ...
    e("echarts/component/visualMap/VisualMapModel", ["require", "zrender/core/util", "zrender/core/env", "../../echarts", "../../util/model", "../../visual/visualDefault", "../../visual/VisualMapping", "../../util/number"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("zrender/core/env"),
        n = t("../../echarts"),
        ...
        return n.extendComponentModel({
            ...
            doMergeOption: function(t, e) {
                var n = this.option;
                i.canvasSupported || (n.realtime = !1),
                this.textStyleModel = this.getModel("textStyle"),
                this.resetItemSize(),
            ...
            formatValueText: function(t, i) {
                ...
                l = this.dataBound,
                u = a.formatter;
                return e.isArray(t) && (t = t.slice(), r = !0),
                o = i ? t: r ? [n(t[0]), n(t[1])] : n(t),
                e.isString(u) ? u.replace("{value}", r ? o[0] : o).replace("{value2}", r ? o[1] : o) : e.isFunction(u) ? r ? u(t[0], t[1]) : u(t) : r ? t[0] === l[0] ? "< " + o[1] : t[1] === l[1] ? "> " + o[0] : o[0] + " - " + o[1] : o
            },
            resetTargetSeries: function(t, e) {
                var i = this.option,
                n = this._autoSeriesIndex = null == (e ? i: t).seriesIndex;
                i.seriesIndex = n ? [] : r.normalizeToArray(i.seriesIndex),
                n && this.ecModel.eachSeries(function(t, e) {
                    var n = t.getData();
            ...
            completeVisualOption: function() {
                ...
                function n(t) {
                    ...
                    function(o) {
                        ...
                        u.symbol || (u.symbol = i && e.clone(i) || (m ? "roundRect": ["roundRect"])),
                        u.symbolSize || (u.symbolSize = n && e.clone(n) || (m ? a[0] : [a[0], a[0]])),
                        u.symbol = s(u.symbol,
                        function(t) {
            ...
            eachTargetSeries: function(t, i) {
                e.each(this.option.seriesIndex,
                function(e) {
    ...
    e("echarts/component/visualMap/ContinuousModel", ["require", "./VisualMapModel", "zrender/core/util", "../../util/number"],
    function(t) {
    ...
    e("echarts/component/visualMap/VisualMapView", ["require", "../../echarts", "zrender/core/util", "../../util/graphic", "../../util/format", "../../util/layout", "../../visual/VisualMapping"],
    function(t) {
        var e = t("../../echarts"),
        i = t("zrender/core/util"),
        n = t("../../util/graphic"),
        ...
        return e.extendComponentView({
            ...
            render: function(t, e, i, n) {
                ...
                t.get("show") === !1 ? void this.group.removeAll() : void this.doRender.apply(this, arguments)
            },
            ...
            getControllerVisual: function(t, e, n) {
                ...
                return i.each(d,
                function(e) {
                    var i = u[e]; (!n || a.isInVisualCluster(e, n)) && i && i.applyVisual(t, r, o)
                }),
                h
            },
    ...
    e("echarts/component/visualMap/helper", ["require", "../../util/layout"],
    function(t) {
        var e = t("../../util/layout"),
        i = {
            getItemAlign: function(t, i, n) {
                ...
                s = "horizontal" === r.orient ? 1 : 0, l = [["left", "right", "width"], ["top", "bottom", "height"]], u = l[s], c = [0, null, 10], h = {},
                d = 0; 3 > d; d++) h[l[1 - s][d]] = c[d],
                h[u[d]] = 2 === d ? n[0] : r[u[d]];
    ...
    e("echarts/component/visualMap/ContinuousView", ["require", "./VisualMapView", "../../util/graphic", "zrender/core/util", "../../util/number", "../helper/sliderMove", "zrender/graphic/LinearGradient", "./helper"],
    function(t) {
        function e(t, e, i) {
        ...
        d = n.extend({
            ...
            _renderBar: function(t) {
                ...
                u.add(n.outOfRange = e()),
                u.add(n.inRange = e(null, o.bind(this._modifyHandle, this, "all"), s ? "move": null));
                var h = i.textStyleModel.getTextRect("国"),
                d = Math.max(h.width, h.height);
                s && (n.handleGroups = [], n.handleThumbs = [], n.handleLabels = [], n.handleLabelPoints = [], this._createHandle(u, 0, r, d, a, l), this._createHandle(u, 1, r, d, a, l)),
                t.add(u)
            },
            ...
            _updateInterval: function(t, e) {
                ...
                this._dataInterval = l(n, [0, i.itemSize[1]], i.getExtent(), !0)
            },
            _updateView: function(t) {
                ...
                n.inRange.setStyle("fill", s.barColor).setShape("points", s.barPoints),
                n.outOfRange.setStyle("fill", l.barColor).setShape("points", l.barPoints),
                this._useHandle && h([0, 1],
                function(t) {
                    n.handleThumbs[t].setStyle("fill", s.handlesColor[t]),
                    n.handleLabels[t].setStyle({
                        text: e.formatValueText(r[t]),
                        textAlign: this._applyTransform("horizontal" === this._orient ? 0 === t ? "bottom": "top": "left", n.barGroup)
                    })
                },
                this),
                this._updateHandlePosition(a)
            },
    ...
    e("echarts/component/visualMap/visualMapAction", ["require", "../../echarts"],
    function(t) {
        var e = t("../../echarts"),
        i = {
            type: "selectDataRange",
    ...
    e("echarts/component/visualMapContinuous", ["require", "../echarts", "./visualMap/preprocessor", "./visualMap/typeDefaulter", "./visualMap/visualCoding", "./visualMap/ContinuousModel", "./visualMap/ContinuousView", "./visualMap/visualMapAction"],
    function(t) {
    ...
    e("echarts/component/visualMap/PiecewiseModel", ["require", "./VisualMapModel", "zrender/core/util", "../../visual/VisualMapping"],
    function(t) {
        function e(t, e) {
        ...
        o = i.extend({
            ...
            doMergeOption: function(t, e) {
                ...
                a[this._mode].call(this),
                this._resetSelected(t, e);
                var r = this.option.categories;
                this.resetVisual(function(t, e) {
                    "categories" === i ? (t.mappingMethod = "category", t.categories = n.clone(r)) : (t.mappingMethod = "piecewise", t.pieceList = n.map(this._pieceList,
                    function(t) {
                        var t = n.clone(t);
        ...
        a = {
            ...
            pieces: function() {
                ...
                function(t, e) {
                    ...
                    if (null != t.label && (o.text = t.label, i = !0), t.hasOwnProperty("value")) o.value = t.value,
                    i || (o.text = this.formatValueText(o.value));
                    else {
                        var a = t.min,
                        s = t.max;
                        null == a && (a = -(1 / 0)),
                        ...
                        a === s && (o.value = a),
                        o.interval = [a, s],
                        i || (o.text = this.formatValueText([a, s]))
                    }
                    o.visual = r.retrieveVisuals(t),
                    this._pieceList.push(o)
                },
                this),
                e(t, this._pieceList)
            }
    ...
    e("echarts/component/visualMap/PiecewiseView", ["require", "./VisualMapView", "zrender/core/util", "../../util/graphic", "../../util/symbol", "../../util/layout", "./helper"],
    function(t) {
        ...
        s = e.extend({
            ...
            doRender: function() {
                function t(t) {
                    ...
                    this._createItemSymbol(r, t.piece, [0, 0, h[0], h[1]]),
                    p && r.add(new n.Text({
                        style: {
                            x: "right" === c ? -a: h[0] + a,
                            y: h[1] / 2,
                ...
                p = !d.endsText,
                f = !p;
                f && this._renderEndsText(e, d.endsText[0], h),
                i.each(d.pieceList, t, this),
                f && this._renderEndsText(e, d.endsText[1], h),
                o.box(r.get("orient"), e, r.get("itemGap")),
                this.renderBackground(e),
                this.positionGroup(e)
            },
            ...
            _onItemClick: function(t) {
                ...
                "single" === n.selectedMode ? (r[o] = !0, i.each(r,
                function(t, e) {
                    r[e] = e === o
                })) : r[o] = !r[o],
                this.api.dispatchAction({
    ...
    e("echarts/component/visualMapPiecewise", ["require", "../echarts", "./visualMap/preprocessor", "./visualMap/typeDefaulter", "./visualMap/visualCoding", "./visualMap/PiecewiseModel", "./visualMap/PiecewiseView", "./visualMap/visualMapAction"],
    function(t) {
        t("../echarts").registerPreprocessor(t("./visualMap/preprocessor")),
        t("./visualMap/typeDefaulter"),
        t("./visualMap/visualCoding"),
    ...
    e("echarts/component/visualMap", ["require", "./visualMapContinuous", "./visualMapPiecewise"],
    function(t) {
        t("./visualMapContinuous"),
        t("./visualMapPiecewise")
    }),
    e("echarts/component/marker/MarkPointModel", ["require", "../../model/globalDefault", "../../util/model", "../../echarts"],
    function(t) {
    ...
    e("echarts/component/marker/markerHelper", ["require", "zrender/core/util", "../../util/number"],
    function(t) {
        function e(t, e, i) {
            var n = -1;
        ...
        s = function(t, e, i) {
            if ((isNaN(i.x) || isNaN(i.y)) && !n.isArray(i.coord) && e) {
                ...
                i = n.extend({},
                i),
                i.type && a[i.type] && l && s ? i.coord = a[i.type](t, l.dim, r, u) : i.coord = [null != i.xAxis ? i.xAxis: i.radiusAxis, null != i.yAxis ? i.yAxis: i.angleAxis]
            }
            return i
        },
        l = function(t, e) {
    ...
    e("echarts/component/marker/MarkPointView", ["require", "../../chart/helper/SymbolDraw", "zrender/core/util", "../../util/format", "../../util/model", "../../util/number", "../../data/List", "./markerHelper", "../../echarts"],
    function(t) {
        function e(t, e, i) {
            var r = e.dimensions,
            o = new u(n.map(r, e.getDimensionInfo, e), i);
            return t && o.initData(n.filter(n.map(i.get("data"), n.curry(c.dataTransform, e, t)), n.curry(c.dataFilter, t)), null, c.dimValueGetter),
            o
        }
        ...
        n.defaults(h, o.dataFormatMixin),
        t("../../echarts").extendComponentView({
            type: "markPoint",
            init: function() {
                this._symbolDrawMap = {}
            ...
            _renderSeriesMP: function(t, r, o) {
                ...
                p.each(function(t) {
                    ...
                    "function" == typeof d && (d = d(r.getRawValue(t), r.getDataParams(t))),
                    p.setItemVisual(t, {
                        symbolSize: d,
                ...
                p.eachItemGraphicEl(function(t) {
                    t.traverse(function(t) {
                        t.hostModel = r
                    })
                }),
    ...
    e("echarts/component/markPoint", ["require", "./marker/MarkPointModel", "./marker/MarkPointView"],
    function(t) {
        t("./marker/MarkPointModel"),
        t("./marker/MarkPointView")
    }),
    e("echarts/component/marker/MarkLineModel", ["require", "../../model/globalDefault", "../../util/model", "../../echarts"],
    function(t) {
        var e = t("../../model/globalDefault"),
        i = t("../../util/model");
        e.markLine = {};
    ...
    e("echarts/component/marker/MarkLineView", ["require", "zrender/core/util", "../../data/List", "../../util/format", "../../util/model", "../../util/number", "./markerHelper", "../../chart/helper/LineDraw", "../../echarts"],
    function(t) {
        function e(t, e) {
        ...
        d = function(t, e, i, r, o) {
            ...
            if (!n.isArray(o) && "min" === a || "max" === a || "average" === a) {
                ...
                m = (p[1] - p[0]) * f + p[0];
                m = r.coordToData(r.dataToCoord(m)),
                h[l] = d[l] = m,
                o = [h, d, {
                    type: a
                }]
        ...
        n.defaults(p, a.dataFormatMixin),
        t("../../echarts").extendComponentView({
            type: "markLine",
            init: function() {
                this._markLineMap = {}
            ...
            _renderSeriesML: function(t, e, r, o) {
                ...
                f.updateData(_, v, y),
                m.line.eachItemGraphicEl(function(t, i) {
                    t.traverse(function(t) {
                        t.hostModel = e
                    })
                }),
    ...
    e("echarts/component/markLine", ["require", "./marker/MarkLineModel", "./marker/MarkLineView"],
    function(t) {
        t("./marker/MarkLineModel"),
        t("./marker/MarkLineView")
    }),
    e("echarts/component/timeline/preprocessor", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            var e = t.type,
            o = {
            ...
            if (o[e] && (t.axisType = o[e], delete t.type), i(t), n(t, "controlPosition")) {
                ...
                n(a, "position") || (a.position = t.controlPosition),
                "none" !== a.position || n(a, "show") || (a.show = !1, delete a.position),
    ...
    e("echarts/component/timeline/typeDefaulter", ["require", "../../model/Component"],
    function(t) {
        t("../../model/Component").registerSubTypeDefaulter("timeline",
        function() {
            return "slider"
        })
    }),
    e("echarts/component/timeline/timelineAction", ["require", "../../echarts"],
    function(t) {
        var e = t("../../echarts");
        e.registerAction({
            type: "timelineChange",
    ...
    e("echarts/component/timeline/TimelineModel", ["require", "../../model/Component", "../../data/List", "zrender/core/util", "../../util/model"],
    function(t) {
        var e = t("../../model/Component"),
        i = t("../../data/List"),
        n = t("zrender/core/util"),
        ...
        o = e.extend({
            ...
            setCurrentIndex: function(t) {
                ...
                this.option.loop ? t = (t % e + e) % e: (t >= e && (t = e - 1), 0 > t && (t = 0)),
            ...
            _initData: function() {
                ...
                if ("category" === o) {
                    ...
                    function(t, e) {
                        ...
                        n.isObject(t) ? (i = n.clone(t), i.value = e) : i = e,
                        s.push(i),
    ...
    e("echarts/component/timeline/SliderTimelineModel", ["require", "./TimelineModel"],
    function(t) {
    ...
    e("echarts/component/timeline/TimelineView", ["require", "../../view/Component"],
    function(t) {
        var e = t("../../view/Component");
        return e.extend({
            type: "timeline"
    ...
    e("echarts/component/timeline/TimelineAxis", ["require", "zrender/core/util", "../../coord/Axis", "../../coord/axisHelper"],
    function(t) {
        var e = t("zrender/core/util"),
        i = t("../../coord/Axis"),
        n = t("../../coord/axisHelper"),
        ...
        return r.prototype = {
            ...
            getLabelInterval: function() {
                ...
                return r || (r = this._autoLabelInterval = n.getAxisLabelInterval(e.map(this.scale.getTicks(), this.dataToCoord, this), n.getFormattedLabels(this, i.get("formatter")), i.getModel("textStyle").getFont(), "horizontal" === t.get("orient"))),
                r
            },
            isLabelIgnored: function(t) {
                if ("category" === this.type) {
    ...
    e("echarts/component/timeline/SliderTimelineView", ["require", "zrender/core/util", "../../util/graphic", "../../util/layout", "./TimelineView", "./TimelineAxis", "../../util/symbol", "../../coord/axisHelper", "zrender/core/BoundingRect", "zrender/core/matrix", "../../util/number", "../../util/model", "../../util/format"],
    function(t) {
        function e(t, e) {
        ...
        function n(t, e, i, n, r, a) {
            ...
            return r ? (r.setStyle(d), r.setColor(l), i.add(r), a && a.onUpdate(r)) : (r = c.createSymbol(s, -h, -h, u, u, l), i.add(r), a && a.onCreate(r)),
            n = o.merge({
                rectHover: !0,
                style: d,
                z2: 100
        ...
        return l.extend({
            ...
            render: function(t, e, i, n) {
                ...
                _(["AxisLine", "AxisTick", "Control", "CurrentPointer"],
                function(e) {
                    this["_render" + e](r, o, s, t)
                },
                this),
                this._renderAxisLabel(r, a, s, t),
                this._position(r, t),
                this._doPlayStop()
            },
            remove: function() {
            ...
            _layout: function(t, i) {
                ...
                L = 0,
                C = u;
                return "left" === b || "bottom" === b ? (w && (g = [0, 0], L += f), M && (v = [L, 0], L += f), S && (y = [C - d, 0], C -= f)) : (w && (g = [C - d, 0], C -= f), M && (v = [0, 0], L += f), S && (y = [C - d, 0], C -= f)),
                _ = [L, C],
                t.get("inverse") && _.reverse(),
                {
                    viewRect: o,
                    mainLength: u,
                    orient: r,
            ...
            _position: function(t, e) {
                ...
                o.position = m,
                a.position = g,
                o.rotation = a.rotation = t.rotation,
                i(o),
                i(a)
            },
            ...
            _renderAxisTick: function(t, e, i, r) {
                ...
                function(t, r) {
                    ...
                    p = n(u, c, e, d);
                    a.setHoverStyle(p, h.getItemStyle()),
                    u.get("tooltip") ? (p.dataIndex = r, p.hostModel = l) : p.dataIndex = p.hostModel = null
                },
                this)
            },
            _prepareTooltipHostModel: function(t, e) {
                var i = m.createDataFormatModel({},
                t, e.get("data")),
                n = this;
            ...
            _renderControl: function(t, e, n, r) {
                ...
                d = r.getPlayState(),
                p = r.get("inverse", !0);
                o(t.nextBtnPosition, "controlStyle.nextIcon", y(this._changeTimeline, this, p ? "-": "+")),
                o(t.prevBtnPosition, "controlStyle.prevIcon", y(this._changeTimeline, this, p ? "+": "-")),
                o(t.playPosition, "controlStyle." + (d ? "stopIcon": "playIcon"), y(this._handlePlayClick, this, !d), !0)
            },
            _renderCurrentPointer: function(t, e, i, o) {
                ...
                c = {
                    onCreate: function(t) {
                        t.draggable = !0,
                        t.drift = y(u._handlePointerDrag, u),
                        t.ondragend = y(u._handlePointerDragend, u),
                        r(t, s, i, o, !0)
                    },
                    onUpdate: function(t) {
                        r(t, s, i, o)
            ...
            _doPlayStop: function() {
                ...
                this._clearTimer(),
                this.model.getPlayState() && (this._timer = setTimeout(y(t, this), this.model.get("playInterval")))
            },
    ...
    e("echarts/component/timeline", ["require", "../echarts", "./timeline/preprocessor", "./timeline/typeDefaulter", "./timeline/timelineAction", "./timeline/SliderTimelineModel", "./timeline/SliderTimelineView"],
    function(t) {
        var e = t("../echarts");
        e.registerPreprocessor(t("./timeline/preprocessor")),
        t("./timeline/typeDefaulter"),
        t("./timeline/timelineAction"),
        t("./timeline/SliderTimelineModel"),
        t("./timeline/SliderTimelineView")
    }),
    e("echarts/component/toolbox/featureManager", ["require"],
    function(t) {
        var e = {};
        return {
    ...
    e("echarts/component/toolbox/ToolboxModel", ["require", "./featureManager", "zrender/core/util", "../../echarts"],
    function(t) {
    ...
    e("echarts/component/toolbox/ToolboxView", ["require", "./featureManager", "zrender/core/util", "../../util/graphic", "../../model/Model", "../../data/DataDiffer", "../helper/listComponent", "zrender/contain/text", "../../echarts"],
    function(t) {
        var e = t("./featureManager"),
        i = t("zrender/core/util"),
        n = t("../../util/graphic"),
            ...
            render: function(t, l, u) {
                ...
                function h(e, r, o) {
                    ...
                    function(o, s) {
                        ...
                        "center");
                        n.setHoverStyle(g),
                        t.get("showTitle") && (g.__title = c[s], g.on("mouseover",
                        function() {
                            g.setStyle({
                                text: c[s],
                        ...
                        g.trigger(e.get("iconStatus." + s) || "normal"),
                        d.add(g),
                        g.on("click", i.bind(r.onclick, r, l, u, s)),
                        m[s] = g
                    })
                }
                var d = this.group;
                if (d.removeAll(), t.get("show")) {
                    ...
                    new o(this._featureNames || [], g).add(c).update(c).remove(i.curry(c, null)).execute(),
    ...
    e("echarts/component/toolbox/feature/SaveAsImage", ["require", "../featureManager"],
    function(t) {
        function e(t) {
            this.model = t
        }
    ...
    e("echarts/component/toolbox/feature/MagicType", ["require", "zrender/core/util", "../../../echarts", "../featureManager"],
    function(t) {
        function e(t) {
            this.model = t
        }
        ...
        n.onclick = function(t, e, n) {
            ...
            if (r[n]) {
                ...
                i.each(o,
                function(t) {
                    i.indexOf(t, n) >= 0 && i.each(t,
                    function(t) {
                        a.setIconStatus(t, "normal")
                    })
                }),
                a.setIconStatus(n, "emphasis"),
                t.eachComponent({
                    mainType: "series",
                    seriesIndex: s
                },
    ...
    e("echarts/component/toolbox/feature/DataView", ["require", "zrender/core/util", "zrender/core/event", "../featureManager", "../../../echarts"],
    function(t) {
        function e(t) {
            var e = {},
            i = [],
        ...
        function r(t) {
            var r = e(t);
            return {
                value: d.filter([i(r.seriesGroupByCategoryAxis), n(r.other)],
                function(t) {
                    return t.replace(/[\n\t\s]/g, "")
                }).join("\n\n" + f + "\n\n"),
                meta: r.meta
        ...
        function s(t) {
            for (var e = t.split(/\n+/g), i = o(e.shift()).split(g), n = [], r = d.map(i,
            function(t) {
                return {
                    name: t,
                    data: []
        ...
        c.prototype.onclick = function(t, e) {
            ...
            c.style.color = o.get("textColor"),
            c.style.borderColor = o.get("textareaBorderColor"),
            c.style.backgroundColor = o.get("textareaColor");
            var h = r(t);
            c.value = h.value;
            var d = h.meta,
            ...
            g += ";background-color:" + o.get("buttonColor"),
            g += ";color:" + o.get("buttonTextColor");
            var _ = this;
            p.addEventListener(v, "click", i),
            ...
            a.appendChild(c),
            a.appendChild(f),
            c.style.height = n.clientHeight - 80 + "px",
            n.appendChild(a),
            this._dom = a
        },
    ...
    e("echarts/component/dataZoom/history", ["require", "zrender/core/util"],
    function(t) {
        function e(t) {
            var e = t[r];
            return e || (e = t[r] = [{}]),
    ...
    e("echarts/component/dataZoom/SelectZoomModel", ["require", "./DataZoomModel"],
    function(t) {
        var e = t("./DataZoomModel");
        return e.extend({
    ...
    e("echarts/component/dataZoom/SelectZoomView", ["require", "./DataZoomView"],
    function(t) {
        return t("./DataZoomView").extend({
            type: "dataZoom.select"
        })
    }),
    e("echarts/component/dataZoomSelect", ["require", "./dataZoom/typeDefaulter", "./dataZoom/DataZoomModel", "./dataZoom/DataZoomView", "./dataZoom/SelectZoomModel", "./dataZoom/SelectZoomView", "./dataZoom/dataZoomProcessor", "./dataZoom/dataZoomAction"],
    function(t) {
        t("./dataZoom/typeDefaulter"),
        t("./dataZoom/DataZoomModel"),
        t("./dataZoom/DataZoomView"),
    ...
    e("echarts/component/toolbox/feature/DataZoom", ["require", "zrender/core/util", "../../../util/number", "../../helper/SelectController", "zrender/core/BoundingRect", "zrender/container/Group", "../../dataZoom/history", "../../helper/interactionMutex", "../../dataZoomSelect", "../featureManager", "../../../echarts"],
    function(t) {
        function e(t) {
            this.model = t,
        ...
        v.onclick = function(t, e, i) {
            ...
            this._controllerGroup || (n = this._controllerGroup = new h, e.getZr().add(n)),
            y[i].call(this, n, this.model, t, e)
        },
        v.remove = function(t, e) {
            this._disposeController(),
            p.release("globalPan", e.getZr())
        },
        v.dispose = function(t, e) {
            var i = e.getZr();
            p.release("globalPan", i),
            this._disposeController(),
    ...
    e("echarts/component/toolbox/feature/Restore", ["require", "../../dataZoom/history", "../featureManager", "../../../echarts"],
    function(t) {
        function e(t) {
            this.model = t
        }
    ...
    e("echarts/component/toolbox", ["require", "./toolbox/ToolboxModel", "./toolbox/ToolboxView", "./toolbox/feature/SaveAsImage", "./toolbox/feature/MagicType", "./toolbox/feature/DataView", "./toolbox/feature/DataZoom", "./toolbox/feature/Restore"],
    function(t) {
    ...
    e("zrender/vml/core", ["require", "../core/env"],
    function(t) {
        function e() {
            if (!a) {
                a = !0;
        ...
        if (!t("../core/env").canvasSupported) {
            ...
            o = r.document,
            a = !1;
            try { ! o.namespaces.zrvml && o.namespaces.add("zrvml", n),
                i = function(t) {
    ...
    e("zrender/vml/graphic", ["require", "../core/env", "../core/vector", "../core/BoundingRect", "../core/PathProxy", "../tool/color", "../contain/text", "../graphic/mixin/RectText", "../graphic/Displayable", "../graphic/Image", "../graphic/Text", "../graphic/Path", "../graphic/Gradient", "./core"],
    function(t) {
        function e(t) {
        ...
        function s(t, e, i) {
            ...
            i = +i,
            isNaN(i) && (i = 1),
            r && (t.color = n(r[0], r[1], r[2]), t.opacity = i * r[3])
        }
        function l(t) {
            var e = b.parse(t);
        ...
        function c(t, e) {
            ...
            null != e.miterLimit && (t.miterlimit = e.miterLimit * V),
            null != e.lineCap && (t.endcap = e.lineCap),
            null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")),
            null == e.stroke || e.stroke instanceof P || s(t, e.stroke, e.opacity)
        }
        function h(t, e, i, n) {
            var a = "fill" == e,
        ...
        function d(t, e) {
            ...
            for (o = 0; o < t.length;) {
                ...
                case u:
                    ...
                    y = t[o++],
                    _ = t[o++];
                    r === d ? (f = y, m = _, y = (y + 2 * g) / 3, _ = (_ + 2 * v) / 3, g = (a + 2 * g) / 3, v = (s + 2 * v) / 3) : (f = t[o++], m = t[o++]),
                    H[0][0] = g,
                    H[0][1] = v,
                    H[1][0] = y,
                    H[1][1] = _,
                ...
                case h:
                    ...
                    v = T + E(O) * A,
                    F = B ? " wa ": " at ";
                    p.push(F, D(((C - P) * M + b) * V - q), R, D(((T - A) * S + w) * V - q), R, D(((C + P) * M + b) * V - q), R, D(((T + A) * S + w) * V - q), R, D((Z * M + b) * V - q), R, D((G * S + w) * V - q), R, D((g * M + b) * V - q), R, D((v * S + w) * V - q)),
                    a = g,
                    s = v;
                    break;
                case x.R:
                    ...
                    W[1] = D(W[1] * V - q),
                    U[1] = D(U[1] * V - q),
                    p.push(" m ", W[0], R, W[1], " l ", U[0], R, W[1], " l ", U[0], R, U[1], " l ", W[0], R, U[1]);
                    break;
                case x.Z:
                    p.push(" x ")
                }
                if (i > 0) {
                    ...
                    for (var j = 0; i > j; j++) {
                        var X = H[j];
                        e && N(X, X, e),
                        p.push(D(X[0] * V - q), R, D(X[1] * V - q), i - 1 > j ? R: "")
                    }
                }
            }
            return p.join("")
        ...
        function m(t, n, o, s) {
            ...
            if (u) {
                ...
                if (y && !s && (J.copy(n), J.applyTransform(y), n = J), s) c = n.x,
                d = n.y;
                else {
                    var _ = l.textPosition,
                    x = l.textDistance;
                    if (_ instanceof Array) c = n.x + _[0],
                    d = n.y + _[1],
                    p = p || "left",
                    v = v || "top";
                    else {
                ...
                var z = [c, d],
                I = P.style;
                y && s ? (N(z, z, y), C.on = !0, C.matrix = y[0].toFixed(3) + R + y[2].toFixed(3) + R + y[1].toFixed(3) + R + y[3].toFixed(3) + ",0,0", C.offset = (D(z[0]) || 0) + "," + (D(z[1]) || 0), C.origin = "0 0", I.left = "0px", I.top = "0px") : (C.on = !1, I.left = D(c) + "px", I.top = D(d) + "px"),
                L.string = i(u);
                try {
                    L.style.font = g
                } catch(k) {}
                ...
                this),
                P.style.zIndex = a(this.zlevel, this.z, this.z2),
                r(t, P)
            }
        }
        function g(t) {
        ...
        if (!t("../core/env").canvasSupported) {
            ...
            T.prototype.brush = function(t) {
                var i = this.style,
                n = this._vmlEl;
                n || (n = A.createNode("shape"), e(n), this._vmlEl = n),
                h(n, "fill", i, this),
                h(n, "stroke", i, this);
                ...
                var p = this.path;
                this.__dirtyPath && (p.beginPath(), this.buildPath(p, this.shape), this.__dirtyPath = !1),
                n.path = d(p.data, this.transform),
                n.style.zIndex = a(this.zlevel, this.z, this.z2),
                r(t, n),
                i.text && this.drawRectText(t, this.getBoundingRect())
            },
            ...
            L.prototype.brush = function(t) {
                ...
                if (s) {
                    ...
                    if (this.transform && (M = this.transform, C = z(M[0] * M[0] + M[1] * M[1]), T = z(M[2] * M[2] + M[3] * M[3]), L = M[1] || M[2]), L) {
                        ...
                        q = O(P[1], I[1], k[1], E[1]),
                        Z = [];
                        Z.push("M11=", M[0] / C, R, "M12=", M[2] / T, R, "M21=", M[1] / C, R, "M22=", M[3] / T, R, "Dx=", D(d * C + M[4]), R, "Dy=", D(f * T + M[5])),
                        S.padding = "0 " + D(V) + "px " + D(q) + "px 0",
                        S.filter = B + ".Matrix(" + Z.join("") + ", SizingMethod=clip)"
                    } else M && (d = d * C + M[4], f = f * T + M[5]),
                    S.filter = "",
                    S.left = D(d) + "px",
                    S.top = D(f) + "px";
                    var G = this._imageEl,
                    ...
                    var F = G.style;
                    if (b) {
                        if (i && n) F.width = D(C * i * m / v) + "px",
                        F.height = D(T * n * g / y) + "px";
                        else {
                            var W = new Image,
                            U = this;
                            W.onload = function() {
                        ...
                        var j = H.style;
                        j.width = D((m + _ * m / v) * C),
                        j.height = D((g + x * g / y) * T),
                        j.filter = B + ".Matrix(Dx=" + -_ * m / v * C + ",Dy=" + -x * g / y * T + ")",
                        H.parentNode || w.appendChild(H),
                        G.parentNode != H && H.appendChild(G)
                    } else F.width = D(C * m) + "px",
                    F.height = D(T * g) + "px",
                    w.appendChild(G),
                    H && H.parentNode && (w.removeChild(H), this._cropEl = null);
                    var X = "",
                    Y = o.opacity;
                    1 > Y && (X += ".Alpha(opacity=" + D(100 * Y) + ") "),
                    X += B + ".AlphaImageLoader(src=" + s + ", SizingMethod=scale)",
                    F.filter = X,
                    w.style.zIndex = a(this.zlevel, this.z, this.z2),
                    r(t, w),
                    o.text && this.drawRectText(t, this.getBoundingRect())
                }
            },
            ...
            w.measureText = function(t, e) {
                ...
                return F.innerHTML = "",
                F.appendChild(i.createTextNode(t)),
                {
                    width: F.offsetWidth
                }
            };
            for (var J = new _,
            K = [M, S, L, T, C], Q = 0; Q < K.length; Q++) {
                var $ = K[Q].prototype;
                $.drawRectText = m,
                $.removeRectText = g,
                $.appendRectText = v
    ...
    e("zrender/vml/Painter", ["require", "../core/log", "./core"],
    function(t) {
        function e(t) {
            return parseInt(t, 10)
        }
        ...
        i.prototype = {
            ...
            _paintList: function(t) {
                ...
                i = 0; i < t.length; i++) {
                    var n = t[i];
                    n.__dirty && !n.invisible && (n.beforeBrush && n.beforeBrush(), n.brush(e), n.afterBrush && n.afterBrush()),
                    n.__dirty = !1
                }
    ...
    e("zrender/vml/vml", ["require", "./graphic", "../zrender", "./Painter"],
    function(t) {
        t("./graphic"),
